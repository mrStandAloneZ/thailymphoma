...
//Web Config
ini_set("session.gc_maxlifetime", 1); // เวลากันเข้าสู่ระบบ
define("WEB_URL", "'http://thailymphomaregistry.org");
define("WEB_EMAIL", "kornpatchara.s@gmail.com");
...
//MySQL table
define("TB_ADD_DATA", "web_add_data");
define("TB_ADMIN", "web_admin");
define("TB_EVENT", "web_event");
define("TB_MEMBER", "web_member");
define("TB_MAIL", "web_mail");
define("TB_THEME", "web_theme");
...
// ส่วนของระบบสมาชิก
//$home = "http://tsh.or.th/lymphoma"; // url เว็บไซด์ของคุณ เวลาที่ต้องการเรียก
$home = "http://localhost:81/public_html"; // url เว็บไซด์ของคุณ เวลาที่ต้องการเรียก
$admin_email = "kornpatchara.s@gmail.com"; // อีเมล์ของคุณ
