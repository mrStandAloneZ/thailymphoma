...
?>
      ...
      <tr>
       ...
       <td align="left" > <br />
        วันที่  <input type="hidden" name="d_record"  value="<?php echo $dbarr['date_todayone']; ?>"  size="2"  readonly="readonly"/><?php echo "$date_todayone"; ?>

        เดือน  <input type="hidden" name="m_record"  value="<?php echo $dbarr['date_todaymonth']; ?>"  size="2"  readonly="readonly"/><?php echo "$date_todaymonth"; ?>

        ปี พ.ศ.<input  type="hidden" maxlength="4" name="y_record" value="<?php echo $dbarr['date_today9']; ?>" readonly="readonly" size="3" /><?php echo "$date_today9"; ?><br /><br />
      </td>
    </tr>
  ...
  <tr>
   ...
   <td width="67%" align="left">
    <input type="text" name="date_bio_report_pathology" size="10"  value="<?php echo $dbarr['date_bio_report_pathology']; ?>" id="date_bio_report" />          (Example: 31/12/(พ.ศ.)2500)</td>
  </tr>
  <tr>
...
?> >  06 : HL, unclassifiable<br /><br />
    ...
    <script language="javascript">
      function show_type_pathology(id) {
						if(id == "Hodgkin lymphoma (HL)") { // ??????? radio button 1 ?????? table 1 ??? ??? table 2
              document.getElementById("type_pathology1").style.display = "";
              document.getElementById("type_pathology2").style.display = "none";
						} else if(id != "Hodgkin lymphoma (HL)") { // ??????? radio button 2 ?????? table 2 ??? ??? table 1
              document.getElementById("type_pathology1").style.display = "none";
              document.getElementById("type_pathology2").style.display = "";
            }
          }
        </script>

        <input type="radio"   name="type_pathology" value="Non-Hodgkin lymphoma (NHL)"  onclick="show_type(this.value);"  <?php if ($dbarr['type_pathology'] == 'Non-Hodgkin lymphoma (NHL)') {
    echo "checked";
}
?> >   Non-Hodgkin lymphoma (NHL)
        &nbsp;&nbsp;Immunophenotype:  &nbsp;&nbsp;
        <select name="immunophenotype_pathology"  style="width:100px;>
         <option  value="" ><?php echo $dbarr['immunophenotype_pathology']; ?></option>
       ...
       <table width="500" border="0" cellpadding="0" cellspacing="0" id="type1" style="display:none">
        <tr>
          <td>
            &nbsp;&nbsp;   <input type="radio" name="type_sub_non_pathology"   value="WHO classification"  <?php if ($dbarr['type_sub_non_pathology'] == 'WHO classification') {
    echo "checked";
}
?> onclick="show_type_sub_non_pathology(this.value);"  >  WHO classification  <br /><br />
            <table width="500" border="0" cellpadding="0" cellspacing="0" id="type_sub_non_pathology1" style="display:none">
              <tr>
                <td>
           ...
           <script language="javascript">
            function show_type_sub_non_pathology(id) {
						if(id == "WHO classification") { // ??????? radio button 1 ?????? table 1 ??? ??? table 2
              document.getElementById("type_sub_non_pathology1").style.display = "";
              document.getElementById("type_sub_non_pathology2").style.display = "none";
						} else if(id != "WHO classification") { // ??????? radio button 2 ?????? table 2 ??? ??? table 1
              document.getElementById("type_sub_non_pathology1").style.display = "none";
              document.getElementById("type_sub_non_pathology2").style.display = "";
            }
          }
        </script>
        &nbsp;&nbsp;
        <input type="radio" name="type_sub_non_pathology"   value="Other type" <?php if ($dbarr['type_sub_non_pathology'] == 'Other type') {
    echo "checked";
}
?> onclick="show_type_other(this.value);" >  99 Other type  <br /><br />

        <table width="500" border="0" cellpadding="0" cellspacing="0" id="other_type1" style="display:none">
          <tr>
            <td>
