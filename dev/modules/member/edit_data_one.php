...
//        $today = date("Y-m-d");   //จุดต้องเปลี่ยน
                    ...
                    <tr>
                        <th align="left" width="32%">Gender:</th>
                        <td colspan="3"> <br />
                            <input type="radio"   name="sex"  value="Male" id="sex1" <?php
                            if ($dbarr['sex'] == 'Male') {
                                echo "checked";
                            }
                            ?> onclick="onaction();"  >  Male  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="sex"  value="Female" id="sex2" <?php
                            if ($dbarr['sex'] == 'Female') {
                                echo "checked";
                            }
                    ...
                    <tr>
                        ...
                        <td colspan="3" > <br />
                            ...
                            <input type="hide" name="id" value="<?php echo $_GET['id']; ?>">
                            <br /><br />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3" > <br />
                            ...
                            (dd/mm/พ.ศ.(2500))<button type="button" onclick="calyear()">cal</button><span id="yearold"></span><input type="hidden" id='input_yearold' value=""><br /><br />
                    ...
                    <tr>
                        ...
                        <td colspan="3" ><br />
                            <input type="radio"  name="payment"  id="payment1" value="Government"  <?php
                            if ($dbarr['payment'] == "Government") {
                                echo "checked";
                            }
                            ?>  onclick="onaction();" />  1. Government  <br /><br />
                            <input type="radio"  name="payment"  id="payment2"  value="Social security" <?php
                            if ($dbarr['payment'] == "Social security") {
                                echo "checked";
                            }
                            ?> onclick="onaction();" />  2. Social security<br /><br />
                            <input type="radio"  name="payment"  id="payment3"  value="Private insurance"  <?php
                            if ($dbarr['payment'] == "Private insurance") {
                                echo "checked";
                            }
                            ?>  onclick="onaction();" > 3. Private insurance<br /><br />
                            <input type="radio"  name="payment"  id="payment4"  value="UC (30 baht)" <?php
                            if ($dbarr['payment'] == "UC (30 baht)") {
                                echo "checked";
                            }
                            ?>  onclick="onaction();" />  4.  UC (30 baht)<br /><br />
                            <input type="radio"  name="payment"  id="payment5"  value="Out of pocket" <?php
                            if ($dbarr['payment'] == "Out of pocket") {
                                echo "checked";
                            }
                            ?>  onclick="onaction();" />  5. Out of pocket<br /><br />
                            <input type="radio"  name="payment"  id="payment6"  value="Other: specify" <?php
                            if ($dbarr['payment'] == "Other: specify") {
                                echo "checked";
                            }
                    ...
                    <tr>
                        ...
                        <td colspan="3" > <br />
                            <input type="radio" name="type"  value="HL" id="type1" <?php
                            if ($dbarr['type'] == 'HL') {
                                echo "checked";
                            }
                            ...
                            <div id="detail_hodgkin">
                                <select name="hodgkin_don" id="hodgkin_don1" style="width:300px;">
                                    <option value="01: Classical HL, Nodular sclerosis" <?php
                                    if ($dbarr['hodgkin_don'] == "01: Classical HL, Nodular sclerosis") {
                                        echo "selected";
                                    }
                                    ?>>01: Classical HL, Nodular sclerosis</option>
                                    <option value="02: Classical HL, Mixed cellularity" <?php
                                    if ($dbarr['hodgkin_don'] == "02: Classical HL, Mixed cellularity") {
                                        echo "selected";
                                    }
                                    ?>>02: Classical HL, Mixed cellularity </option>
                                    <option value="03: Classical HL, Lymphocyte-rich" <?php
                                            if ($dbarr['hodgkin_don'] == "03: Classical HL, Lymphocyte-rich") {
                                                echo "selected";
                                            }
                                            ?>>03: Classical HL, Lymphocyte-rich </option>
                                    <option value="04: Classical HL, Lymphocyte-depleted" <?php
                                    if ($dbarr['hodgkin_don'] == "04: Classical HL, Lymphocyte-depleted") {
                                        echo "selected";
                                    }
                                    ?>>04: Classical HL, Lymphocyte-depleted </option>
                                    <option value="05: HL, Nodular lymphocyte predominant" <?php
                                    if ($dbarr['hodgkin_don'] == "05: HL, Nodular lymphocyte predominant") {
                                        echo "selected";
                                    }
                                    ?>>05: HL, Nodular lymphocyte predominant</option>
                                    <option value="06: HL, unclassifiable" <?php
                            if ($dbarr['hodgkin_don'] == "06: HL, unclassifiable") {
                                echo "selected";
                            }
                                    ?>>06: HL, unclassifiable</option>
                                </select>
                            </div>

                            <input type="radio"   name="type" value="NHL"  id="type2" <?php
                            if ($dbarr['type'] == "NHL") {
                                echo "checked";
                            }
                            ...
                            <div id="detail_non_hodgkin">
                                ...
                                <br />
                                <input type="radio"   name="type_sub_non" value="WHO"  id="type_sub_non1" <?php
                                       if ($dbarr['type_sub_non'] == "WHO") {
                                           echo "checked";
                                       }
                                    ?>   />   WHO classification  <br />
                                <select name="who_sub" id="who_sub" style="width:400px;">
                                    <option value="">Please select..</option>
                                    <option value="07 : Precursor B-lymphoblastic lymphoma" <?php
                                    if ($dbarr["who_sub"] == "07 : Precursor B-lymphoblastic lymphoma") {
                                        echo " selected";
                                    }
                                    ?> >07 : Precursor B-lymphoblastic lymphoma</option>
                                    <option value="08 : Small lymphocytic lymphoma" <?php
                                    if ($dbarr["who_sub"] == "08 : Small lymphocytic lymphoma") {
                                        echo " selected";
                                    }
                                    ?> >08 : Small lymphocytic lymphoma</option>
                                    <option value="09 : Lymphoplasmacytic lymphoma" <?php
                                            if ($dbarr["who_sub"] == "09 : Lymphoplasmacytic lymphoma") {
                                                echo " selected";
                                            }
                                            ?> >09 : Lymphoplasmacytic lymphoma</option>
                                    <option value="10 : Splenic marginal zone lymphoma" <?php
                                    if ($dbarr["who_sub"] == "10 : Splenic marginal zone lymphoma") {
                                        echo " selected";
                                    }
                                    ?> >10 : Splenic marginal zone lymphoma</option>
                                    <option value="11 : Extranodal marginal zone lymphoma of MALT type" <?php
                                    if ($dbarr["who_sub"] == "11 : Extranodal marginal zone lymphoma of MALT type") {
                                        echo " selected";
                                    }
                                    ?> >11 : Extranodal marginal zone lymphoma of MALT type</option>
                                    <option value="12 : Nodal marginal zone lymphoma" <?php
                                            if ($dbarr["who_sub"] == "12 : Nodal marginal zone lymphoma") {
                                                echo " selected";
                                            }
                                            ?> >12 : Nodal marginal zone lymphoma</option>
                                    <option value="13A : In situ follicular neoplasia" <?php
                                    if ($dbarr["who_sub"] == "13A : In situ follicular neoplasia") {
                                        echo " selected";
                                    }
                                    ?> >13A : In situ follicular neoplasia</option>
                                    <option value="13B : Duodenal-type follicular lymphoma" <?php
                                    if ($dbarr["who_sub"] == "13B : Duodenal-type follicular lymphoma") {
                                        echo " selected";
                                    }
                                    ?> >13B : Duodenal-type follicular lymphoma</option>
                                    <option value="13 : Follicular lymphoma, grade 1" <?php
                                            if ($dbarr["who_sub"] == "13 : Follicular lymphoma, grade 1") {
                                                echo " selected";
                                            }
                                            ?> >13 : Follicular lymphoma, grade 1</option>
                                    <option value="14 : Follicular lymphoma, grade 2" <?php
                                    if ($dbarr["who_sub"] == "14 : Follicular lymphoma, grade 2") {
                                        echo " selected";
                                    }
                                    ?> >14 : Follicular lymphoma, grade 2</option>
                                    <option value="15 : Follicular lymphoma, grade 3" <?php
                                    if ($dbarr["who_sub"] == "15 : Follicular lymphoma, grade 3") {
                                        echo " selected";
                                    }
                                    ?> >15 : Follicular lymphoma, grade 3</option>
                                    <option value="16A : In situ mantle cell neoplasia" <?php
                                            if ($dbarr["who_sub"] == "16A : In situ mantle cell neoplasia") {
                                                echo " selected";
                                            }
                                            ?> >16A : In situ mantle cell neoplasia</option>
                                    <option value="16 : Mantle cell lymphoma" <?php
                                    if ($dbarr["who_sub"] == "16 : Mantle cell lymphoma") {
                                        echo " selected";
                                    }
                                    ?> >16 : Mantle cell lymphoma</option>
                                    <option value="17 : Diffuse large B-cell lymphoma (DLBCL), NOS" <?php
                                    if ($dbarr["who_sub"] == "17 : Diffuse large B-cell lymphoma (DLBCL), NOS") {
                                        echo " selected";
                                    }
                                    ?> >17 : Diffuse large B-cell lymphoma (DLBCL), NOS</option>
                                    <option value="17A : Germinal center B-cell (GCB) DLBCL" <?php
                                            if ($dbarr["who_sub"] == "17A : Germinal center B-cell (GCB) DLBCL") {
                                                echo " selected";
                                            }
                                            ?> >17A : Germinal center B-cell (GCB) DLBCL</option>
                                    <option value="17B : Activated B-cell (ABC) DLBCL" <?php
                                    if ($dbarr["who_sub"] == "17B : Activated B-cell (ABC) DLBCL") {
                                        echo " selected";
                                    }
                                    ?> >17B : Activated B-cell (ABC) DLBCL</option>
                                    <option value="18 : Mediastinal (thymic) large B-cell lymphoma" <?php
                                    if ($dbarr["who_sub"] == "18 : Mediastinal (thymic) large B-cell lymphoma") {
                                        echo " selected";
                                    }
                                    ?> >18 : Mediastinal (thymic) large B-cell lymphoma</option>
                                    <option value="19 : Intravascular large B-cell lymphoma" <?php
                                            if ($dbarr["who_sub"] == "19 : Intravascular large B-cell lymphoma") {
                                                echo " selected";
                                            }
                                            ?> >19 : Intravascular large B-cell lymphoma</option>
                                    <option value="20 : Primary effusion lymphoma" <?php
                                    if ($dbarr["who_sub"] == "20 : Primary effusion lymphoma") {
                                        echo " selected";
                                    }
                                    ?> >20 : Primary effusion lymphoma</option>
                                    <option value="21 : Burkitt lymphoma" <?php
                                    if ($dbarr["who_sub"] == "21 : Burkitt lymphoma") {
                                        echo " selected";
                                    }
                                    ?> >21 : Burkitt lymphoma</option>
                                    <option value="22 : Lymphomatoid granulomatosis" <?php
                                            if ($dbarr["who_sub"] == "22 : Lymphomatoid granulomatosis") {
                                                echo " selected";
                                            }
                                            ?> >22 : Lymphomatoid granulomatosis</option>
                                    <option value="23 : Post-transplant lymphoproliferative disorders(PTLD)" <?php
                                    if ($dbarr["who_sub"] == "23 : Post-transplant lymphoproliferative disorders(PTLD)") {
                                        echo " selected";
                                    }
                                    ?> >23 : Post-transplant lymphoproliferative disorders(PTLD)</option>
                                    <option value="24 : Precursor T-lymphoblastic lymphoma" <?php
                                    if ($dbarr["who_sub"] == "24 : Precursor T-lymphoblastic lymphoma") {
                                        echo " selected";
                                    }
                                    ?> >24 : Precursor T-lymphoblastic lymphoma</option>
                                    <option value="25 : Extranodal NK/T-cell lymphoma, nasal type" <?php
                                            if ($dbarr["who_sub"] == "25 : Extranodal NK/T-cell lymphoma, nasal type") {
                                                echo " selected";
                                            }
                                            ?> >25 : Extranodal NK/T-cell lymphoma, nasal type</option>
                                    <option value="26 : Enteropathy-type T-cell lymphoma" <?php
                                    if ($dbarr["who_sub"] == "26 : Enteropathy-type T-cell lymphoma") {
                                        echo " selected";
                                    }
                                    ?> >26 : Enteropathy-type T-cell lymphoma</option>
                                    <option value="26A : Enteropathy-associated T-cell lymphoma(TypeI EALT)" <?php
                                    if ($dbarr["who_sub"] == "26A : Enteropathy-associated T-cell lymphoma(TypeI EALT)") {
                                        echo " selected";
                                    }
                                    ?> >26A : Enteropathy-associated T-cell lymphoma(TypeI EALT)</option>
                                    <option value="26B : Monomorphic epitheliotroptic intestinal T-cell lymphoma(TypeII EATL)" <?php
                                            if ($dbarr["who_sub"] == "26B : Monomorphic epitheliotroptic intestinal T-cell lymphoma(TypeII EATL)") {
                                                echo " selected";
                                            }
                                            ?> >26B : Monomorphic epitheliotroptic intestinal T-cell lymphoma(TypeII EATL)</option>
                                    <option value="27 : Hepatosplenic T-cell lymphoma" <?php
                                    if ($dbarr["who_sub"] == "27 : Hepatosplenic T-cell lymphoma") {
                                        echo " selected";
                                    }
                                    ?> >27 : Hepatosplenic T-cell lymphoma</option>
                                    <option value="28 : Subcutaneous panniculitis-like T-cell lymphoma" <?php
                                    if ($dbarr["who_sub"] == "28 : Subcutaneous panniculitis-like T-cell lymphoma") {
                                        echo " selected";
                                    }
                                    ?> >28 : Subcutaneous panniculitis-like T-cell lymphoma</option>
                                    <option value="29 : Aggressive NK-cell leukemia/lymphoma" <?php
                                            if ($dbarr["who_sub"] == "29 : Aggressive NK-cell leukemia/lymphoma") {
                                                echo " selected";
                                            }
                                            ?> >29 : Aggressive NK-cell leukemia/lymphoma</option>
                                    <option value="30 : Mycosis fungoides/Sezary syndrome" <?php
                                    if ($dbarr["who_sub"] == "30 : Mycosis fungoides/Sezary syndrome") {
                                        echo " selected";
                                    }
                                    ?> >30 : Mycosis fungoides/Sezary syndrome</option>
                                    <option value="31 : Angioimmunblastic T-cell lymphoma" <?php
                                if ($dbarr["who_sub"] == "31 : Angioimmunblastic T-cell lymphoma") {
                                    echo " selected";
                                }
                                ?> >31 : Angioimmunblastic T-cell lymphoma</option>
                                    <option value="32 : Primary cutaneous anaplastic large cell lymphoma" <?php
                                if ($dbarr["who_sub"] == "32 : Primary cutaneous anaplastic large cell lymphoma") {
                                    echo " selected";
                                }
                                ?> >32 : Primary cutaneous anaplastic large cell lymphoma</option>
                                    <option value="33 : Anaplastic large cell lymphoma, ALK positive" <?php
                                if ($dbarr["who_sub"] == "33 : Anaplastic large cell lymphoma, ALK positive") {
                                    echo " selected";
                                }
                                ?> >33 : Anaplastic large cell lymphoma, ALK positive</option>
                                    <option value="34 : Peripheal T-cell lymphoma, unspecified, NOS" <?php
                                if ($dbarr["who_sub"] == "34 : Peripheal T-cell lymphoma, unspecified, NOS") {
                                    echo " selected";
                                }
                                ?> >34 : Peripheal T-cell lymphoma, unspecified, NOS</option>
                                    <option value="--**New entity**--" <?php
                                if ($dbarr["who_sub"] == "--**New entity**--") {
                                    echo " selected";
                                }
                                ?> >--**New entity**--</option>
                                    <option value="35 : T-cell/histiocyte-rich large B-cell lymphoma" <?php
                                if ($dbarr["who_sub"] == "35 : T-cell/histiocyte-rich large B-cell lymphoma") {
                                    echo " selected";
                                }
                                ?> >35 : T-cell/histiocyte-rich large B-cell lymphoma</option>
                                    <option value="36 : Primary cutaneous follicle enter lymphoma" <?php
                                if ($dbarr["who_sub"] == "36 : Primary cutaneous follicle enter lymphoma") {
                                    echo " selected";
                                }
                                ?> >36 : Primary cutaneous follicle enter lymphoma</option>
                                    <option value="37 : Primary DLBCL of the CNS" <?php
                                if ($dbarr["who_sub"] == "37 : Primary DLBCL of the CNS") {
                                    echo " selected";
                                }
                                ?> >37 : Primary DLBCL of the CNS</option>
                                    <option value="38 : Primry cutaneous DLBCL, leg type " <?php
                                if ($dbarr["who_sub"] == "38 : Primry cutaneous DLBCL, leg type ") {
                                    echo " selected";
                                }
                                ?> >38 : Primry cutaneous DLBCL, leg type </option>
                                    <option value="39 : EBV+DLBCL NOS " <?php
                                if ($dbarr["who_sub"] == "39 : EBV+DLBCL NOS ") {
                                    echo " selected";
                                }
                                ?> >39 : EBV+DLBCL NOS </option>
                                    <option value="40 : ALK positive large B-cell lymphoma" <?php
                                if ($dbarr["who_sub"] == "40 : ALK positive large B-cell lymphoma") {
                                    echo " selected";
                                }
                                ?> >40 : ALK positive large B-cell lymphoma</option>
                                    <option value="41 : Plasmablastic lymphoma" <?php
                                if ($dbarr["who_sub"] == "41 : Plasmablastic lymphoma") {
                                    echo " selected";
                                }
                                ?> >41 : Plasmablastic lymphoma</option>
                                    <option value="42 : Large B-cell lymphoma arising in HHV8-associated multicentric Castleman disease(HHV8+ DLBCL, NOS)" <?php
                                if ($dbarr["who_sub"] == "42 : Large B-cell lymphoma arising in HHV8-associated multicentric Castleman disease(HHV8+ DLBCL, NOS)") {
                                    echo " selected";
                                }
                                ?> >42 : Large B-cell lymphoma arising in HHV8-associated multicentric Castleman disease(HHV8+ DLBCL, NOS)</option>
                                    <option value="43 : With features intermediate between DLBCL and Burkitt lymphoma" <?php
                                if ($dbarr["who_sub"] == "43 : With features intermediate between DLBCL and Burkitt lymphoma") {
                                    echo " selected";
                                }
                                ?> >43 : With features intermediate between DLBCL and Burkitt lymphoma</option>
                                    <option value="43A : High-grade B-call lymphoma, with feature intermediate between DLBCL and classical Hodgkin lymphoma" <?php
                                if ($dbarr["who_sub"] == "43A : High-grade B-call lymphoma, with feature intermediate between DLBCL and classical Hodgkin lymphoma") {
                                    echo " selected";
                                }
                                ?> >43A : High-grade B-call lymphoma, with feature intermediate between DLBCL and classical Hodgkin lymphoma</option>
                                    <option value="44 : B-cell lymphoma, unclassifiable, with features intermediate between DLBCL and classical Hodgkin lymphoma" <?php
                                if ($dbarr["who_sub"] == "44 : B-cell lymphoma, unclassifiable, with features intermediate between DLBCL and classical Hodgkin lymphoma") {
                                    echo " selected";
                                }
                                ?> >44 : B-cell lymphoma, unclassifiable, with features intermediate between DLBCL and classical Hodgkin lymphoma</option>
                                    <option value="45 : Chronic lymphoproliferative disorder of NK-cells" <?php
                                if ($dbarr["who_sub"] == "45 : Chronic lymphoproliferative disorder of NK-cells") {
                                    echo " selected";
                                }
                                ?> >45 : Chronic lymphoproliferative disorder of NK-cells</option>
                                    <option value="46 : Lymphomatoid papulosis" <?php
                                if ($dbarr["who_sub"] == "46 : Lymphomatoid papulosis") {
                                    echo " selected";
                                }
                                ?> >46 : Lymphomatoid papulosis</option>
                                    <option value="47 : Primary cutaneous gamma-delta T-cell lymphoma" <?php
                                if ($dbarr["who_sub"] == "47 : Primary cutaneous gamma-delta T-cell lymphoma") {
                                    echo " selected";
                                }
                                ?> >47 : Primary cutaneous gamma-delta T-cell lymphoma</option>
                                    <option value="48 : Primary cutaneous CD8 positive aggressive epidermotropic cytotoxic T-cell lymphoma" <?php
                                if ($dbarr["who_sub"] == "48 : Primary cutaneous CD8 positive aggressive epidermotropic cytotoxic T-cell lymphoma") {
                                    echo " selected";
                                }
                                ?> >48 : Primary cutaneous CD8 positive aggressive epidermotropic cytotoxic T-cell lymphoma</option>
                                    <option value="49 : Primary cutaneous CD4 positive small/medium T-cell lymphoma" <?php
                                if ($dbarr["who_sub"] == "49 : Primary cutaneous CD4 positive small/medium T-cell lymphoma") {
                                    echo " selected";
                                }
                                ?> >49 : Primary cutaneous CD4 positive small/medium T-cell lymphoma</option>
                                    <option value="50 : Anaplastic large cell lymphoma, ALK negative" <?php
                                if ($dbarr["who_sub"] == "50 : Anaplastic large cell lymphoma, ALK negative") {
                                    echo " selected";
                                }
                                ?> >50 : Anaplastic large cell lymphoma, ALK negative</option>
                                    <option value="51 : Breast implant-associated anaplastic large-cell lymphoma" <?php
                                        if ($dbarr["who_sub"] == "51 : Breast implant-associated anaplastic large-cell lymphoma") {
                                            echo " selected";
                                        }
                                        ?> >51 : Breast implant-associated anaplastic large-cell lymphoma</option>
                                    <option value="52 : DLBCL associated with chronic inflammation" <?php
                                        if ($dbarr["who_sub"] == "52 : DLBCL associated with chronic inflammation") {
                                            echo " selected";
                                        }
                                        ?> >52 : DLBCL associated with chronic inflammation</option>
                                </select>
                                <br />
                                <input type="radio"  name="type_sub_non"  id="type_sub_non2" value="Working formulation"  <?php
                                        if ($dbarr['type_sub_non'] == "Working formulation") {
                                            echo "checked";
                                        }
                                ...
                                <br />
                                <input type="radio" name="type_sub_non"  id="type_sub_non3"  value="99 Other type" <?php
                                        if ($dbarr['type_sub_non'] == "99 Other type") {
                                            echo "checked";
                                        }
                                        ?> />  99 Other type  <br />
                    ...
                    <tr>
                        ...
                        <td colspan="3" > <br />
                            ...
                            <table width="100%" border="0" align="center">
                                <tr>
                                    <td>   <input type="radio" name="ann_arbor" id="ann_arbor1"   value="I"  <?php
                                if ($dbarr['ann_arbor'] == "I") {
                                    echo "checked";
                                }
                                ?> onclick="onaction();
                                        checkage();" />   I           </td>
                                    <td>    <input type="radio" name="ann_arbor"  id="ann_arbor2"  value="II"  <?php
                                if ($dbarr['ann_arbor'] == "II") {
                                    echo "checked";
                                }
                                ?> onclick="onaction();
                                        checkage();" />   II   </td>
                                ...
                                <tr>
                                    <td><input type="radio" name="ann_arbor" id="ann_arbor3"   value="III" <?php
                                if ($dbarr['ann_arbor'] == "III") {
                                    echo "checked";
                                }
                                ?> onclick="onaction();
                                        checkage();" />   III </td>
                                    <td><input type="radio" name="ann_arbor" id="ann_arbor4"  value="IV" <?php
                                if ($dbarr['ann_arbor'] == "IV") {
                                    echo "checked";
                                }
                                ?> onclick="onaction();
                                        checkage();" />   IV</td>
                                ...
                                <tr>
                                    <th><b>Symptom</b></th>
                                    <td><br /><input type="radio" name="symptom_ann" id="symptom_ann1"  value="A"<?php
                                if ($dbarr['symptom_ann'] == "A") {
                                    echo "checked";
                                }
                                ?>   onclick="onaction();
                                        checkage();" />  A  <br /><br />
                                        <input type="radio" name="symptom_ann"  id="symptom_ann2"  value="B" <?php
                                if ($dbarr['symptom_ann'] == "B") {
                                    echo "checked";
                                }
                                ?> onclick="onaction();
                                        checkage();" /> B <br /><br />
                    ...
                    <tr>
                        ...
                        <td colspan="3" > <br />
                            <br />
                            <input type="checkbox" name="ext_none"   value="ext_done"  id="ext_none" <?php
                                if ($dbarr['ext_none'] == "ext_done") {
                                    echo "checked";
                                }
                                ?>  />  none
                            ...
                            <div id="extra_site">
                                <br />
                                <input type="checkbox" name="ext_wal"   value="Waldeyer" id="ext_wal" <?php
                                if ($dbarr['ext_wal'] == 'Waldeyer') {
                                    echo "checked";
                                }
                                ?> onclick="checkage();" />  Waldeyer's ring &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="ext_sin"   value="Sinonasal"  id="ext_sin"<?php
                                if ($dbarr['ext_sin'] == 'Sinonasal') {
                                    echo "checked";
                                }
                                ?> onclick="checkage();"/>   Sinonasal  &nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="ext_sal"   value="Salivary gland"  id="ext_sal"<?php
                                if ($dbarr['ext_sal'] == 'Salivary gland') {
                                    echo "checked";
                                }
                                ?> onclick="checkage();"/>  Salivary gland  &nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="ext_thy"   value="Thyroid"   id="ext_thy" <?php
                                if ($dbarr['ext_thy'] == 'Thyroid') {
                                    echo "checked";
                                }
                                ?> onclick="checkage();" /> Thyroid &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="ext_eye"   value="Eye/Ocular adnexa"   id="ext_eye"<?php
                                if ($dbarr['ext_eye'] == 'Eye/Ocular adnexa') {
                                    echo "checked";
                                }
                                ?> onclick="checkage();"/> Eye/Ocular adnexa<br /><br />
                                <br />
                                <input type="checkbox" name="ext_lung"   value="Lung/Pleura"   id="ext_lung"<?php
                                if ($dbarr['ext_lung'] == 'Lung/Pleura') {
                                    echo "checked";
                                }
                                ?> onclick="checkage();"/>  Lung/Pleura &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php //******   ฟิลด์ที่เพิ่มขึ้นมาใหม่   ?>
                                <input type="checkbox" name="ext_breast"   value="Breast" id="ext_breast" <?php
                                if ($dbarr['ext_breast'] == 'Breast') {
                                    echo "checked";
                                }
                                ?> onclick="checkage();"/>  Breast   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="ext_stomach"   value="Stomach"  id="ext_stomach"<?php
                                if ($dbarr['ext_stomach'] == 'Stomach') {
                                    echo "checked";
                                }
                                ?> onclick="checkage();"/> Stomach  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="ext_small"   value="Small intestine" id="ext_small" <?php
                                if ($dbarr['ext_small'] == 'Small intestine') {
                                    echo "checked";
                                }
                                ?> onclick="checkage();"/> Small intestine  &nbsp;
                                <input type="checkbox" name="ext_testis"   value="Testis" id="ext_testis"  <?php
                            if ($dbarr['ext_testis'] == 'Testis') {
                                echo "checked";
                            }
                            ?> onclick="checkage();"/> Testis<br /><br />
                                <br />
                                <input type="checkbox" name="ext_brain"   value="Brain/CNS"  id="ext_brain"<?php
                            if ($dbarr['ext_brain'] == 'Brain/CNS') {
                                echo "checked";
                            }
                            ?> onclick="checkage();" /> Brain/CNS  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="ext_liver"   value="Liver"  id="ext_liver"<?php
                            if ($dbarr['ext_liver'] == 'Liver') {
                                echo "checked";
                            }
                            ?> onclick="checkage();" /> Liver  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="ext_large"   value="Large intestine"   id="ext_large"<?php
                                   if ($dbarr['ext_large'] == 'Large intestine') {
                                       echo "checked";
                                   }
                            ?> onclick="checkage();"/> Large intestine  &nbsp;&nbsp;
                                <input type="checkbox" name="ext_bone"   value="Bone marrow" id="ext_bone"<?php
                                   if ($dbarr['ext_bone'] == 'Bone marrow') {
                                       echo "checked";
                                   }
                                   ?> onclick="checkage();"  /> Bone marrow  &nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="ext_spleen"   value="Spleen"   id="ext_spleen"<?php
                                   if ($dbarr['ext_spleen'] == 'Spleen') {
                                       echo "checked";
                                   }
                                   ?> onclick="checkage();"/> Spleen  <br /><Br /><Br />
                                <input type="checkbox" name="ext_skin"   value="Skin/Subcutaneous"  id="ext_skin"<?php
                                   if ($dbarr['ext_skin'] == 'Skin/Subcutaneous') {
                                       echo "checked";
                                   }
                                   ?> onclick="checkage();" /> Skin/Subcutaneous<br /><br /><Br />
                                <input type="checkbox" name="ext_other"   value="Others" id="ext_other" <?php
                            if ($dbarr['ext_other'] == 'Others') {
                                echo "checked";
                            }
                            ?>  onclick="checkage();"/> Others
                                ...
                                You should use comma(,) between each site such as xxx,xxx2.
                    ...
                    <tr>
                        ...
                        <td colspan="3" > <br />
                            <input type="radio"   name="per_ecog"  id="per_ecog0" value="0"  <?php
                            if ($dbarr['per_ecog'] == "0") {
                                echo "checked";
                            }
                            ?> onclick="onaction();
                                           checkage();" /> 0 &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="per_ecog"  id="per_ecog1" value="1"  <?php
                            if ($dbarr['per_ecog'] == "1") {
                                echo "checked";
                            }
                            ?> onclick="onaction();
                                           checkage();" />  1 &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="per_ecog"  id="per_ecog2"  value="2"  <?php
                                   if ($dbarr['per_ecog'] == "2") {
                                       echo "checked";
                                   }
                                   ?> onclick="onaction();
                                           checkage();" /> 2 &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="per_ecog"  id="per_ecog3" value="3"   <?php
                                   if ($dbarr['per_ecog'] == "3") {
                                       echo "checked";
                                   }
                                   ?>onclick="onaction();
                                           checkage();"/> 3 &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="per_ecog"  id="per_ecog4" value="4" <?php
                            if ($dbarr['per_ecog'] == "4") {
                                echo "checked";
                            }
                            ?> onclick="onaction();
                    ...
                    <tr>
                        ...
                        <td colspan="3" > <br />
                            <input type="radio"   name="ldh"  value="Normal"  id="ldh1"  <?php
                            if ($dbarr['ldh'] == "Normal") {
                                echo "checked";
                            }
                            ?> onclick="onaction();
                                           checkage();"  />  Normal  &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="ldh"  value="High"  id="ldh2" <?php
                            if ($dbarr['ldh'] == "High") {
                                echo "checked";
                            }
                            ?> onclick="onaction();
                    ...
                    <tr>
                        ...
                        <td><br /><input type="text"   name="hemoglobin" id="hemoglobin"   value="<?php echo $dbarr['hemoglobin']; ?>"   >  Hemoglobin(g/dl) <br /><br />
                            ...
                            Blast/Lymphoma cell(yes/no) <input type="radio"   name="blast_lymphoma"  id="blast_lymphoma1"  value="Yes"  <?php
                                   if ($dbarr['blast_lymphoma'] == "Yes") {
                                       echo "checked";
                                   }
                                   ?> > Yes  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="blast_lymphoma"  id="blast_lymphoma2"  value="No"  <?php
                                   if ($dbarr['blast_lymphoma'] == "No") {
                                       echo "checked";
                                   }
                                   ?> > No
                            <br /><br />
                    ...
                    <tr>
                        ...
                        <td><br /><b>HBsAg</b>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="hep_b_hbsag"   value="posiive" <?php
                                   if ($dbarr['hep_b_hbsag'] == "posiive") {
                                       echo "checked";
                                   }
                                   ?> >  posiive  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="hep_b_hbsag"   value="negative" <?php
                                   if ($dbarr['hep_b_hbsag'] == "negative") {
                                       echo "checked";
                                   }
                                   ?>  >  negative  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="hep_b_hbsag"   value="not done"  <?php
                                   if ($dbarr['hep_b_hbsag'] == "not done") {
                                       echo "checked";
                                   }
                                   ?> >  not done  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /><br />
                            <b>Anti-HBcAb </b>
                            <input type="radio"   name="hep_b_anti_hbcab"   value="posiive"  <?php
                                   if ($dbarr['hep_b_anti_hbcab'] == "posiive") {
                                       echo "checked";
                                   }
                                   ?> >  posiive  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="hep_b_anti_hbcab"   value="negative"  <?php
                                   if ($dbarr['hep_b_anti_hbcab'] == "negative") {
                                       echo "checked";
                                   }
                                   ?> >  negative  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="hep_b_anti_hbcab"   value="not done"  <?php
                                   if ($dbarr['hep_b_anti_hbcab'] == "not done") {
                                       echo "checked";
                                   }
                                   ?> >  not done  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /><br />
                            <b>Anti-HBsAb </b>
                            <input type="radio"   name="hep_b_anti_hbsab"   value="posiive"  <?php
                                   if ($dbarr['hep_b_anti_hbsab'] == "posiive") {
                                       echo "checked";
                                   }
                                   ?> >  posiive  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="hep_b_anti_hbsab"   value="negative" <?php
                                   if ($dbarr['hep_b_anti_hbsab'] == "negative") {
                                       echo "checked";
                                   }
                                   ?>  >  negative  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="hep_b_anti_hbsab"   value="not done"  <?php
                                   if ($dbarr['hep_b_anti_hbsab'] == "not done") {
                                       echo "checked";
                                   }
                                   ?> >  not done  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /><br />
                    ...
                    <tr>
                        ...
                        <td><br /><b> Anti-HCV</b>  &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="hep_c_anti_hcv"   value="posiive" <?php
                                   if ($dbarr['hep_c_anti_hcv'] == "posiive") {
                                       echo "checked";
                                   }
                                   ?>  >  posiive  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="hep_c_anti_hcv"   value="negative"   <?php
                                   if ($dbarr['hep_c_anti_hcv'] == "negative") {
                                       echo "checked";
                                   }
                                   ?>>  negative  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="hep_c_anti_hcv"   value="not done" <?php
                                   if ($dbarr['hep_c_anti_hcv'] == "not done") {
                                       echo "checked";
                                   }
                                   ?>  >  not done  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /><br />
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><br />
                            <input type="radio"   name="hiv_positive" id="hiv_positive1" value="Yes"  <?php
                                   if ($dbarr['hiv_positive'] == "Yes") {
                                       echo "checked";
                                   }
                                   ?>  onclick="onaction();" />  Yes &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="hiv_positive" id="hiv_positive2" value="No" <?php
                                   if ($dbarr['hiv_positive'] == 'No') {
                                       echo "checked";
                                   }
                                   ?> onclick="onaction();" />  No &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio"   name="hiv_positive" id="hiv_positive3"  value="Not done" <?php
                                   if ($dbarr['hiv_positive'] == 'Not done') {
                                       echo "checked";
                                   }
                        ...
                        <td colspan="4" align="center">
                            ...
                            <script type="text/javascript">
                              ...
                              $(document).ready(function () {
                                ...
                                function checkage() {
                                    var yearsold = document.getElementById('input_yearold').value;
                                    var yearold =  parseInt(yearsold );
                                    if (yearold) {
                                        var score = 0;
