...
// คำสั่ง SQL และสั่งให้ทำงาน
	$sql = "select * from $tblname where member_id='$bb' and status='ยังไม่อนุมัติ'  ";
		...
		elseif ($dd =='300')
		{  $sql = "select * from $tblname where typepa='$ty' and status='อนุมัติ' ";   }
else {
...
$sql2 = "select * from $tblname  where member_id='$bb'  and status='ยังไม่อนุมัติ' order by id limit  $Gopage,$Pagesize";	 
		...
		elseif ($dd =='300')
			{  	$sql2 = "select * from $tblname  where typepa='$ty' and status='อนุมัติ'  order by id limit  $Gopage,$Pagesize";	   }
else {
