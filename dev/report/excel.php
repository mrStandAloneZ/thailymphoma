<?
header("Content-Type: application/vnd.ms-excel; name='excel';charset='utf8' ");
header("Content-Disposition: attachment; filename=lymphoma-cmu.xls");
?>
<html>
<body>
...
<?
	...
	$strSQL = "SELECT * FROM web_add_data  where codehos='CMU' ";
