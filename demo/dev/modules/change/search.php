...
echo"</p></div><div class='x'></div><div class='break'></div></div>";
...
?>
        <? 
		echo " แสดงรายการค้นหาคำว่า<font color='blue'> <b>$keyword</b></font> จากส่วน<font color='blue'> <b>$fields</b></font> พบ<font color='blue'> <b>$num_rows</b></font> กระทู้ ";  ?><br>
        <br><br />
      </div>
      </div>
...
<table width="95%" border="0" cellpadding="0" >
  <tr bgcolor="#F3F3F3"> 
    <td height="25"><A HREF="index.php?name=change&file=read&id=<? echo $id;?>"><? echo $topic ;?></a> 
    </td>
