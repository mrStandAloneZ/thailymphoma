...
<tr><td colspan="3" height="30" bgcolor="#799fff">&nbsp;&nbsp;<IMG SRC="images/icon/graph-i.gif" BORDER="0" ALIGN="absmiddle"> <FONT SIZE="2" COLOR="#FFFFFF"><B><?=$CatShow;?></B></FONT></td></tr>
<tr height="20">
...
$Color = 0; 
$BoardResult = $db->select_query("SELECT * FROM ".TB_WEBBOARD." $SQLwhere2 ORDER BY update_date DESC  LIMIT $goto, $limit ");
while($WebBoard = $db->fetch($BoardResult)){
	...
	echo "<tr height=\"20\"><td bgcolor=\"".$ColorFill."\"><IMG SRC=\"images/icon/dok.gif\" BORDER=\"0\" ALIGN=\"absmiddle\"> <B>".sprintf("%0"._NUM_ID."d",$WebBoard[id])." : </B> <A HREF=\"?name=change&file=read&id=".$WebBoard[id]."\">".$WebBoard[topic]."</A> ";
	//กรณีแนบรูป
	if($WebBoard[picture]){
