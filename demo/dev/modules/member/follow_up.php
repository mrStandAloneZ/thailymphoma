...
$sqlSession = "select * from " . TB_MEMBER . " where user='" . $_SESSION['login_true'] . "'";
$result = mysql_query($sqlSession) or die("Err Can not to result");
$dbarrCode = mysql_fetch_array($result);
$centre = $dbarrCode['codehos'];
include "modules/index/header.php";
//$db->connectdb(DB_NAME, DB_USERNAME, DB_PASSWORD);
//$login_true=$_SESSION['login_true'];
$sqlData = "select * from " . TB_ADD_DATA . " where id='" . $_GET['id'] . "' order by id DESC";

$resultData = mysql_query($sqlData) or die("Err Can not to result");
$dbarr = mysql_fetch_array($resultData);
///////////////////
$date_today = date("d/m/");
$year_now = date("Y") + '543';
...
<div id="center">
    ...
    <p>
    <center>
        <form name ="checkForm" action="?name=member&file=follow_registry_update" method="post"  enctype="multipart/form-data">
            ...
            <table width="100%" border="0" align="center">
                ...
                <tr>
                    ...
                    <td width="44%" align="center" colspan="2"><br />
                        <input name="chemotherapy_follow" id="chemotherapy_follow_yes" type="radio" value="Chemotherapy"  <?php
                        if ($dbarr['chemotherapy_follow'] == "Chemotherapy") {
                            echo "checked";
                        }
                        ?>  onclick="onaction();" /> Yes  &nbsp;&nbsp;&nbsp;
                        <input name="chemotherapy_follow" id="chemotherapy_follow_no" type="radio" value="No Chemotherapy" <?php
                        if ($dbarr['chemotherapy_follow'] == "No Chemotherapy") {
                            echo "checked";
                        }
                        ?>  onclick="onaction();" /> No
                        <br /><br />
                                ...
                                <tr>
                                    ...
                                    <td align="left" >
                                        ...
                                        <table width="491" border="0" cellpadding="0" cellspacing="4" >
                                            <tr align="left">
                                                <td width="30%" align="left"><input name="chemo_select_follow" id="chemo_select_follow1" type="radio" value="Ch+/-P"  <?php
                                                    if ($dbarr['chemo_select_follow'] == 'Ch+/-P') {
                                                        echo "checked";
                                                    }
                                                    ?> >              Ch+/-P</td>
                                                <td width="23%" align="left"><input name="chemo_select_follow" id="chemo_select_follow2" type="radio" value="CP"  <?php
                                                    if ($dbarr['chemo_select_follow'] == 'CP') {
                                                        echo "checked";
                                                    }
                                                    ?>>              CP</td>
                                                <td width="23%" align="left"><input name="chemo_select_follow" id="chemo_select_follow3" type="radio" value="CVP (COP)" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'CVP (COP)') {
                                                        echo "checked";
                                                    }
                                                    ?> >     CVP (COP)</td>
                                                <td width="24%" align="left"><input name="chemo_select_follow" id="chemo_select_follow4" type="radio" value="CHOP-14" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'CHOP-14') {
                                                        echo "checked";
                                                    }
                                                    ?> />        CHOP-14</td>
                                            </tr>
                                            <tr align="left">
                                                <td><input name="chemo_select_follow" type="radio" value="CHOP-21" id="chemo_select_follow5" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'CHOP-21') {
                                                        echo "checked";
                                                    }
                                                    ?>  />            CHOP-21</td>
                                                <td><input name="chemo_select_follow" type="radio" value="CHOEP"  id="chemo_select_follow6" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'CHOEP') {
                                                        echo "checked";
                                                    }
                                                    ?> />             CHOEP</td>
                                                <td><input name="chemo_select_follow" type="radio" value="CNOP"  id="chemo_select_follow7" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'CNOP') {
                                                        echo "checked";
                                                    }
                                                    ?>>              CNOP</td>
                                                <td><input name="chemo_select_follow" type="radio" value="EPOCH" id="chemo_select_follow8" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'EPOCH') {
                                                        echo "checked";
                                                    }
                                                    ?> />          EPOCH</td>
                                            </tr>
                                            <tr align="left">
                                                <td><input name="chemo_select_follow" type="radio" value="CHOP-ESHAP" id="chemo_select_follow9"  <?php
                                                    if ($dbarr['chemo_select_follow'] == 'CHOP-ESHAP') {
                                                        echo "checked";
                                                    }
                                                    ?>/>
                                                    CHOP-ESHAP</td>
                                                <td><input name="chemo_select_follow" type="radio" value="HyperCVAD" id="chemo_select_follow10" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'HyperCVAD') {
                                                        echo "checked";
                                                    }
                                                    ?> />
                                                    HyperCVAD</td>
                                                <td><input name="chemo_select_follow" type="radio" value="F" id="chemo_select_follow11"  <?php
                                                    if ($dbarr['chemo_select_follow'] == 'F') {
                                                        echo "checked";
                                                    }
                                                    ?> />     F</td>
                                                <td><input name="chemo_select_follow" type="radio" value="FC"  id="chemo_select_follow12" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'FC') {
                                                        echo "checked";
                                                    }
                                                    ?> />   FC</td>
                                            </tr>
                                            <tr align="left">
                                                <td><input name="chemo_select_follow" type="radio" value="FN+/-D"  id="chemo_select_follow13" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'FN+/-D') {
                                                        echo "checked";
                                                    }
                                                    ?> />  FN+/-D</td>
                                                <td><input name="chemo_select_follow" type="radio" value="FCM" id="chemo_select_follow14" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'FCM') {
                                                        echo "checked";
                                                    }
                                                    ?>  />      FCM</td>
                                                <td><input name="chemo_select_follow" type="radio" value="COPP"  id="chemo_select_follow15" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'COPP') {
                                                        echo "checked";
                                                    }
                                                    ?> />    COPP</td>
                                                <td><input name="chemo_select_follow" type="radio" value="ABV" id="chemo_select_follow16" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'ABV') {
                                                        echo "checked";
                                                    }
                                                    ?> />       ABV</td>
                                            </tr>
                                            ...
                                            <tr align="left">
                                                <td><input name="chemo_select_follow" type="radio" value="COPP-ABV" id="chemo_select_follow17" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'COPP-ABV') {
                                                        echo "checked";
                                                    }
                                                    ?> />   COPP-ABV</td>
                                                <td><input name="chemo_select_follow" type="radio" value="ABVD" id="chemo_select_follow18" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'ABVD') {
                                                        echo "checked";
                                                    }
                                                    ?> />          ABVD</td>
                                                <td><input name="chemo_select_follow" type="radio" value="BEACOP" id="chemo_select_follow19" <?php
                                                    if ($dbarr['chemo_select_follow'] == 'BEACOP') {
                                                        echo "checked";
                                                    }
                                                    ?> />      BEACOPP</td>
                                                <td align="left"><input name="chemo_select_follow" type="radio" id="chemo_select_follow20" value="CODOX-M"   <?php
                                                    if ($dbarr['chemo_select_follow'] == 'CODOX-M') {
                                                        echo "checked";
                                                    }
                                                    ?> />   CODOX-M</td>
                                            </tr>
                                            <tr align="left">
                                                <td align="left"><input name="chemo_select_follow" type="radio" id="chemo_select_follow21" value="CODOX-M/IVAC"  <?php
                                                    if ($dbarr['chemo_select_follow'] == "CODOX-M/IVAC") {
                                                        echo "checked";
                                                    }
                                                    ?> />           CODOX-M/IVAC</td>
                                                <td align="left"><input name="chemo_select_follow" type="radio" id="chemo_select_follow22" value="ALL regimen"   <?php
                                                    if ($dbarr['chemo_select_follow'] == 'ALL regimen') {
                                                        echo "checked";
                                                    }
                                                    ?> />            ALL regimen</td>
                                                <td align="left"><input name="chemo_select_follow" type="radio" id="chemo_select_follow23" value="Bendamustine"   <?php
                                                    if ($dbarr['chemo_select_follow'] == 'Bendamustine') {
                                                        echo "checked";
                                                    }
                                                    ?> />            Bendamustine</td>
                                                <td align="left"><input name="chemo_select_follow" type="radio" id="chemo_select_follow24" value="Ibrutinib"   <?php
                                                    if ($dbarr['chemo_select_follow'] == 'Ibrutinib') {
                                                        echo "checked";
                                                    }
                                                    ?> />            Ibrutinib</td>
                                            </tr>
                                            <tr>
                                                <td align="left"><input name="chemo_select_follow" id="chemo_select_follow23" type="radio" value="Other"    <?php
                                                    if ($dbarr['chemo_select_follow'] == 'Other') {
                                                        echo "checked";
                                                    }
                                                    ?> />    Other</td>
                                                <td colspan="3" align="left"><input name="chemo_select_follow_other" id="chemo_select_follow_other" type="text" value="<?php echo $dbarr['chemo_select_follow_other']; ?>" size="20" /></td>
                                            </tr>
                                            <tr>
                                                <td align="left" colspan="4">Received Intrathecal chemotherapy    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <input name="received_follow" id="received_follow1"  type="radio" value="Yes"  <?php
                                                    if ($dbarr['received_follow'] == 'Yes') {
                                                        echo "checked";
                                                    }
                                                    ?>>    Yes   &nbsp;&nbsp;&nbsp;&nbsp;
                                                    <input name="received_follow" id="received_follow2"  type="radio" value="No"  <?php
                                                    if ($dbarr['received_follow'] == 'No') {
                                                        echo "checked";
                                                    }
                                                    ?>>    No
                                                </td>
                ...
                <tr>
                    ...
                    <td align="center"> <br />&nbsp;
                        <input name="immunotherapy_follow_yes" id="immunotherapy_follow_yes" type="radio" value="Immunotherapy"  <?php
                        if ($dbarr['immunotherapy_follow'] == 'Immunotherapy' || $dbarr['immunotherapy_follow'] == 'Yes') {
                            echo "checked";
                        }
                        ?>   onclick="onaction();"  />  Yes &nbsp;&nbsp;&nbsp;
                        <input name="immunotherapy_follow_no" id="immunotherapy_follow_no" type="radio" value="Immunotherapy_no"  <?php
                        if ($dbarr['immunotherapy_follow'] == 'Immunotherapy_no' || $dbarr['immunotherapy_follow'] == 'No') {
                            echo "checked";
                        }
                        ?>  onclick="onaction();"  />  No
                        <br /><br />
                        ...
                        <div id="immuno_follow_n2_yes">
                            ...
                            <table width="500" border="0" cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td align="left"><br />
                                        <input name="immun_select_follow" id="immun_select_follow1" type="radio" value="Rituximab" <?php
                                        if ($dbarr['immun_select_follow'] == "Rituximab") {
                                            echo "checked";
                                        }
                                        ?> onclick="onaction();"  />  Rituximab (Mark all that apply)  <br /><br />

                                        <div id="immun_select_follow2_no"></div>
                                        <div  id="immun_select_follow1_show">
                                            <table width="500" border="0" cellpadding="0" cellspacing="0" >
                                                <tr>
                                                    <td><br />
                                                        <input name="immun_select_follow_sub[]" id="rituximab_1" type="checkbox"  value="Induction" <?php
                                                        if (strlen(strstr($dbarr['immun_other_text'], "Induction")) > 0) {
                                                            echo "checked";
                                                        }
                                                        ?> onclick="onaction();"  />  Induction  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <input name="immun_select_follow_sub[]"  id="rituximab_2" type="checkbox"  value="Maintenance" <?php
                                        ...
                                        <input name="immun_select_follow" id="immun_select_follow2" type="radio"  value="Obinutuzumab" <?php
                                        if ($dbarr['immun_select_follow'] == "Obinutuzumab") {
                                            echo "checked";
                                        }
                                        ?> onclick="onaction();" />  Obinutuzumab  <br /><br />
                                        <input name="immun_select_follow"  id="immun_select_follow3" type="radio"  value="Brentuximab" <?php
                                        if ($dbarr['immun_select_follow'] == "Brentuximab") {
                                            echo "checked";
                                        }
                                        ?> onclick="onaction();" />  Brentuximab  <br /><br />
                                        <input name="immun_select_follow" id="immun_select_follow4" type="radio" value="Ibritumomab" <?php
                                        if ($dbarr['immun_select_follow'] == "Ibritumomab") {
                                            echo "checked";
                                        }
                                        ?> onclick="onaction();"  /> Ibritumomab  <br /><br />
                                        <input name="immun_select_follow" id="immun_select_follow5"  type="radio" value="Alemtuzumab" <?php
                                        if ($dbarr['immun_select_follow'] == "Alemtuzumab") {
                                            echo "checked";
                                        }
                                        ?> onclick="onaction();" />  Alemtuzumab  <br /><br />
                                        <input name="immun_select_follow" id="immun_select_follow6"  type="radio" value="Other" <?php
                                        if ($dbarr['immun_select_follow'] == "Other") {
                                            echo "checked";
                                        }
                ...
                <tr>
                    ...
                    <td align="center" colspan="2"> <br />&nbsp;
                        <input name="radiotherapy_follow" id="radiotherapy_follow_yes" type="radio" value="Radiotherapy"  <?php
                        if ($dbarr['radiotherapy_follow'] == 'Radiotherapy') {
                            echo "checked";
                        }
                        ?>   onclick="onaction();"  />  Yes &nbsp;&nbsp;&nbsp;
                        <input name="radiotherapy_follow" id="radiotherapy_follow_no" type="radio" value="Radiotherapy_no"  <?php
                        if ($dbarr['radiotherapy_follow'] == 'Radiotherapy_no') {
                            echo "checked";
                        }
                        ?>   onclick="onaction();"  />  No
                        <br /><br />
                ...
                <tr>
                    ...
                    <td align="center" ><br />&nbsp;
                        <input type="radio" name="surgery_follow" id="surgery_follow_yes"  value="yes"  <?php
                        if ($dbarr['surgery_follow'] == "yes") {
                            echo "checked";
                        }
                        ?>  onclick="onaction();"  />  Yes &nbsp;&nbsp;&nbsp;
                        <input name="surgery_follow" id="surgery_follow_no" type="radio" value="no" <?php
                        if ($dbarr['surgery_follow'] == "no") {
                            echo "checked";
                        }
                ...
                <tr>
                    <th align="center" > <br />
                        ...
                        <br /><br /></th>
                    <td align="center"><input name="no_treatment_follow"  id="no_treatment_follow" type="checkbox" value="No (including observation)"  <?php
                        if ($dbarr['no_treatment_follow'] == 'No (including observation)') {
                            echo "checked";
                        }
                ...
                <tr>
                    <td></td>
                    <td align="left"><br />
                        <input name="result_follow" type="radio" id="result_follow1"  value="Complete response (CR)" <?php
                        if ($dbarr['result_follow'] == "Complete response (CR)") {
                            echo "checked";
                        }
                        ...
                        <br />
                        <input name="result_follow" type="radio" id="result_follow2"  value="Complete response (uncomfirmed) (CRu)"<?php
                        if ($dbarr['result_follow'] == "Complete response (uncomfirmed) (CRu)") {
                            echo "checked";
                        }
                        ...
                        <br /><br />
                        <input name="result_follow" type="radio" value="Partial response (PR)" id="result_follow3"  <?php
                        if ($dbarr['result_follow'] == 'Partial response (PR)') {
                            echo "checked";
                        }
                        ?>  onclick="onaction();"   />            Partial response (PR)  <br /><br />
                        <input name="result_follow" type="radio" value="Stable disease (SD)" id="result_follow4" <?php
                        if ($dbarr['result_follow'] == 'Stable disease (SD)') {
                            echo "checked";
                        }
                        ?>  onclick="onaction();"  />                        Stable disease (SD)<br /><br />
                        <input name="result_follow" type="radio" value="Progressive disease (PD)" id="result_follow5"  <?php
                        if ($dbarr['result_follow'] == 'Progressive disease (PD)') {
                            echo "checked";
                        }
                        ?>  onclick="onaction();"  />
                        Progressive disease (PD)<br /><br />
                        <input name="result_follow" type="radio" value="Indeterminate (ID)" id="result_follow6" <?php
                        if ($dbarr['result_follow'] == "Indeterminate (ID)") {
                            echo "checked";
                        }
                        ?>  onclick="onaction();"  />
                        ...
                        <div id="cause">
                            <b>  Cause    </b>        &nbsp;&nbsp;&nbsp;
                            <input name="result_cause_follow" id="result_cause_follow1" type="radio" value="Death" <?php
                            if ($dbarr['result_cause_follow'] == 'Death') {
                                echo "checked";
                            }
                            ?>> Death
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input name="result_cause_follow" id="result_cause_follow2" type="radio" value="Loss to follow up" <?php
                            if ($dbarr['result_cause_follow'] == 'Loss to follow up') {
                                echo "checked";
                            }
                            ?>> Loss to follow up
                        </div>
                ...
                <tr>
                    ...
                    <td><br />
                        <input name="progression_follow" type="radio" value="Yes"  <?php
                        if ($dbarr['progression_follow'] == 'Yes') {
                            echo "checked";
                        }
                        ?> id="progression_follow_yes"  onclick="onaction();"  />      Yes &nbsp;&nbsp;&nbsp;

                        <input name="progression_follow" type="radio" value="No"   <?php
                        if ($dbarr['progression_follow'] == 'No') {
                            echo "checked";
                        }
                        ...
                        <div id="sub_progression_follow_yes">
                            ...
                            <input name="histology_follow" id="histology_follow1" type="radio" value="Yes" <?php
                            if ($dbarr['histology_follow'] == 'Yes') {
                                echo "checked";
                            }
                            ?>>  Yes    &nbsp;&nbsp;&nbsp;
                            <input name="histology_follow"  id="histology_follow2" type="radio" value="No" <?php
                            if ($dbarr['histology_follow'] == 'No') {
                                echo "checked";
                            }
                            ?>> No &nbsp;&nbsp;&nbsp;
                            <input name="histology_follow"  id="histology_follow3" type="radio" value="Unknown" <?php
                            if ($dbarr['histology_follow'] == 'Unknown') {
                                echo "checked";
                            }
                            ?>> Unknown
                            <br /><br />
                            <b>   Progression/relapse sites (mark all that apply) </b> <br /><br />
                            <input name="lymphnode_follow" id="lymphnode_follow" type="checkbox"  value="Lymph node"  <?php
                            if ($dbarr['lymphnode_follow'] == 'Lymph node') {
                                echo "checked";
                            }
                            ?>>         Lymph node   <br /><br />
                            <input type="checkbox" name="extranodal_follow" id="extranodal_follow" value="Extranodal sites" <?php
                            if ($dbarr['extranodal_follow'] == 'Extranodal sites') {
                                echo "checked";
                            }
                            ?>    >
                            ...
                            <table width="500" border="0" cellpadding="0" cellspacing="0"  >
                                <tr align="left">
                                    <td width="128"><input type="checkbox" name="extr_1_follow"  id="extr_1_follow" value="Waldeyer's ring" <?php
                                        if ($dbarr['extr_1_follow'] == "Waldeyer's ring") {
                                            echo "checked";
                                        }
                                        ?> />           Waldeyer's ring</td>
                                    <td width="96"><input type="checkbox" name="extr_2_follow"  id="extr_2_follow"  value="Sinonasal" <?php
                                        if ($dbarr['extr_2_follow'] == "Sinonasal") {
                                            echo "checked";
                                        }
                                        ?> />Sinonasal</td>
                                    <td width="99"><input type="checkbox" name="extr_3_follow" id="extr_3_follow" value="Salivary gland"<?php
                                        if ($dbarr['extr_3_follow'] == 'Salivary gland') {
                                            echo "checked";
                                        }
                                        ?> />Salivary gland</td>
                                    <td width="77"><input type="checkbox" name="extr_4_follow" id="extr_4_follow" value="Thyroid"<?php
                                        if ($dbarr['extr_4_follow'] == 'Thyroid') {
                                            echo "checked";
                                        }
                                        ?> />Thyroid</td>
                                </tr>
                                <tr align="left">
                                    <td><input type="checkbox" name="extr_5_follow" id="extr_5_follow" value="Eye/Ocular adnexa"<?php
                                        if ($dbarr['extr_5_follow'] == 'Eye/Ocular adnexa') {
                                            echo "checked";
                                        }
                                        ?> />Eye/Ocular adnexa</td>
                                    <td><input type="checkbox" name="extr_6_follow" id="extr_6_follow" value="Lung/Pleura"<?php
                                        if ($dbarr['extr_6_follow'] == 'Lung/Pleura') {
                                            echo "checked";
                                        }
                                        ?> />Lung/Pleura</td>
                                    <td><input type="checkbox" name="extr_7_follow" id="extr_7_follow" value="Breast" <?php
                                        if ($dbarr['extr_7_follow'] == 'Breast') {
                                            echo "checked";
                                        }
                                        ?> />         Breast</td>
                                    <td><input type="checkbox" name="extr_8_follow" id="extr_8_follow" value="Stomach" <?php
                                        if ($dbarr['extr_8_follow'] == 'Stomach') {
                                            echo "checked";
                                        }
                                        ?> />            Stomach</td>
                                </tr>
                                <tr align="left">
                                    <td><input type="checkbox" name="extr_9_follow" id="extr_9_follow"  value="Small intestine" <?php
                                        if ($dbarr['extr_9_follow'] == 'Small intestine') {
                                            echo "checked";
                                        }
                                        ?> />            Small intestine</td>
                                    <td><input type="checkbox" name="extr_10_follow" id="extr_10_follow" value="Testis"<?php
                                        if ($dbarr['extr_10_follow'] == 'Testis') {
                                            echo "checked";
                                        }
                                        ?> />            Testis</td>
                                    <td><input type="checkbox" name="extr_11_follow" id="extr_11_follow" value="Brain/CNS"<?php
                                        if ($dbarr['extr_11_follow'] == 'Brain/CNS') {
                                            echo "checked";
                                        }
                                        ?> />         Brain/CNS</td>
                                    <td><input type="checkbox" name="extr_12_follow" id="extr_12_follow" value="Liver" <?php
                                        if ($dbarr['extr_12_follow'] == 'Liver') {
                                            echo "checked";
                                        }
                                        ?> />           Liver</td>
                                </tr>
                                <tr align="left">
                                    <td><input type="checkbox" name="extr_13_follow" id="extr_13_follow" value="Large intestine"<?php
                                        if ($dbarr['extr_13_follow'] == 'Large intestine') {
                                            echo "checked";
                                        }
                                        ?> />           Large intestine</td>
                                    <td><input type="checkbox" name="extr_14_follow" id="extr_14_follow" value="Bone" <?php
                                        if ($dbarr['extr_14_follow'] == 'Bone') {
                                            echo "checked";
                                        }
                                        ?> />            Bone</td>
                                    <td><input type="checkbox" name="extr_15_follow" id="extr_15_follow" value="Bone marrow"  <?php
                                        if ($dbarr['extr_15_follow'] == 'Bone marrow') {
                                            echo "checked";
                                        }
                                        ?> />            Bone marrow</td>
                                    <td><input type="checkbox" name="extr_16_follow" id="extr_16_follow" value="Spleen" <?php
                                        if ($dbarr['extr_16_follow'] == 'Spleen') {
                                            echo "checked";
                                        }
                                        ?> />          Spleen</td>
                                </tr>
                                ...
                                <tr align="left">
                                    <td><input type="checkbox" name="extr_17_follow" id="extr_17_follow" value="Skin/Subcutaneous"<?php
                                        if ($dbarr['extr_17_follow'] == 'Skin/Subcutaneous') {
                                            echo "checked";
                                        }
                                ...
                                <tr align="left">
                                    <td colspan="4">
                                        <table width="400" border="0" cellpadding="0" cellspacing="0" >
                                            <tr>
                                                <td width="60" valign="top"><input type="checkbox" name="extr_other" id="extr_other" value="other"  <?php
                                                    if ($dbarr['extr_other'] == 'other') {
                                                        echo "checked";
                                                    }
                                                    ?> />
                                                    Others</td>
                                                <td><textarea name="extr_other_text" cols="40" rows="4"  id="extr_other_text"><?php echo $dbarr['extr_other_text']; ?></textarea></td>
                                            </tr>
                ...
                <tr>
                    <th align="left" >
                        <strong><font color="#990033" size="+1">Salvage treatment </font><span style="padding-left:25px;">        <br /> <font color="#990033">  Salvage regimen (mark all that apply)          </font></th>
                                <td> <br />
                                    <input name="salvage_follow" type="radio" value="Yes"<?php
                                    if ($dbarr['salvage_follow'] == "Yes") {
                                        echo "checked";
                                    }
                                    ?>  id="salvage_follow_yes"  onclick="onaction();"  />Yes  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input name="salvage_follow" type="radio" value="No"<?php
                                    if ($dbarr['salvage_follow'] == "No") {
                                        echo "checked";
                                    }
                ...
                <div id="salvage_follow_detail">
                    ...
                    <input name="chemo_follow_1" type="checkbox" value="DHAP" id="chemo_follow_1" <?php
                    if ($dbarr['chemo_follow_1'] == "DHAP") {
                        echo "checked";
                    }
                    ?> />   DHAP  &nbsp;&nbsp;&nbsp;
                    <input name="chemo_follow_2" type="checkbox" value="ESHAP" id="chemo_follow_2" <?php
                    if ($dbarr['chemo_follow_2'] == "ESHAP") {
                        echo "checked";
                    }
                    ?> />  ESHAP &nbsp;
                    <input name="chemo_follow_3" type="checkbox"  value="MINE" id="chemo_follow_3" <?php
                    if ($dbarr['chemo_follow_3'] == 'MINE') {
                        echo "checked";
                    }
                    ?>>MINE  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="chemo_follow_4" type="checkbox"  value="IMVP-16"id="chemo_follow_4" <?php
                    if ($dbarr['chemo_follow_4'] == 'IMVP-16') {
                        echo "checked";
                    }
                    ?>>  IMVP-16  &nbsp;&nbsp;
                    <input name="chemo_follow_5" type="checkbox"  value="ICE" id="chemo_follow_5"<?php
                    if ($dbarr['chemo_follow_5'] == 'ICE') {
                        echo "checked";
                    }
                    ?>>ICE  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="chemo_follow_6" type="checkbox" value="Gemcitabine-regimen" id="chemo_follow_6"<?php
                    if ($dbarr['chemo_follow_6'] == 'Gemcitabine-regimen') {
                        echo "checked";
                    }
                    ?>>Gemcitabine-regimen  <br /><br />
                    <input name="chemo_follow_7" type="checkbox"  value="Ch+/-P"id="chemo_follow_7"<?php
                    if ($dbarr['chemo_follow_7'] == 'Ch+/-P') {
                        echo "checked";
                    }
                    ?>>Ch+/-P  &nbsp;&nbsp;
                    <input name="chemo_follow_8" type="checkbox" value="CP" id="chemo_follow_8"<?php
                    if ($dbarr['chemo_follow_8'] == 'CP') {
                        echo "checked";
                    }
                    ?>>CP &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="chemo_follow_9" type="checkbox" value="CVP (COP)" id="chemo_follow_9"<?php
                    if ($dbarr['chemo_follow_9'] == 'CVP (COP)') {
                        echo "checked";
                    }
                    ?>>CVP (COP) &nbsp;&nbsp;
                    <input name="chemo_follow_10" type="checkbox"value="CHOP-14"id="chemo_follow_10"<?php
                    if ($dbarr['chemo_follow_10'] == 'CHOP-14') {
                        echo "checked";
                    }
                    ?>> CHOP-14&nbsp;&nbsp;&nbsp;
                    <input name="chemo_follow_11" type="checkbox" value="CHOP-21" id="chemo_follow_11"<?php
                    if ($dbarr['chemo_follow_11'] == 'CHOP-21') {
                        echo "checked";
                    }
                    ?>>CHOP-21&nbsp;
                    <input name="chemo_follow_12" type="checkbox"  value="CHOEP" id="chemo_follow_12"<?php
                    if ($dbarr['chemo_follow_12'] == 'CHOEP') {
                        echo "checked";
                    }
                    ?>>CHOEP  <br /><Br />
                    <input name="chemo_follow_13" type="checkbox" value="CNOP" id="chemo_follow_13"<?php
                    if ($dbarr['chemo_follow_13'] == 'CNOP') {
                        echo "checked";
                    }
                    ?>> CNOP  &nbsp;&nbsp;&nbsp;
                    <input name="chemo_follow_14" type="checkbox" value="EPOCH" id="chemo_follow_14"<?php
                    if ($dbarr['chemo_follow_14'] == 'EPOCH') {
                        echo "checked";
                    }
                    ?>>EPOCH  &nbsp;
                    <input name="chemo_follow_15" type="checkbox"  value="CHOP-ESHAP" id="chemo_follow_15"<?php
                    if ($dbarr['chemo_follow_15'] == 'CHOP-ESHAP') {
                        echo "checked";
                    }
                    ?>>CHOP-ESHAP
                    <input name="chemo_follow_16" type="checkbox" value="HyperCVAD" id="chemo_follow_16"<?php
                    if ($dbarr['chemo_follow_16'] == 'HyperCVAD') {
                        echo "checked";
                    }
                    ?>> HyperCVAD
                    <input name="chemo_follow_17" type="checkbox"  value="F" id="chemo_follow_17"<?php
                    if ($dbarr['chemo_follow_17'] == 'F') {
                        echo "checked";
                    }
                    ?>>F &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="chemo_follow_18" type="checkbox" value="FC" id="chemo_follow_18"<?php
                    if ($dbarr['chemo_follow_18'] == 'FC') {
                        echo "checked";
                    }
                    ?>>FC  <br /><br />
                    <input name="chemo_follow_19" type="checkbox"  value="FN+/-D" id="chemo_follow_19"<?php
                    if ($dbarr['chemo_follow_19'] == 'FN+/-D') {
                        echo "checked";
                    }
                    ?>>FN+/-D  &nbsp;&nbsp;
                    <input name="chemo_follow_20" type="checkbox"value="FCM" id="chemo_follow_20"<?php
                    if ($dbarr['chemo_follow_20'] == 'FCM') {
                        echo "checked";
                    }
                    ?>> FCM &nbsp;&nbsp;&nbsp;
                    <input name="chemo_follow_21" type="checkbox" value="COPP"id="chemo_follow_21" <?php
                    if ($dbarr['chemo_follow_21'] == 'COPP') {
                        echo "checked";
                    }
                    ?>>COPP &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="chemo_follow_22" type="checkbox" value="ABV"id="chemo_follow_22"<?php
                    if ($dbarr['chemo_follow_22'] == 'ABV') {
                        echo "checked";
                    }
                    ?>>ABV  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="chemo_follow_23" type="checkbox" value="COPP-ABV" id="chemo_follow_23"<?php
                    if ($dbarr['chemo_follow_23'] == 'COPP-ABV') {
                        echo "checked";
                    }
                    ?>>COPP-ABV
                    <input name="chemo_follow_24" type="checkbox" value="ABVD" id="chemo_follow_24"<?php
                    if ($dbarr['chemo_follow_24'] == 'ABVD') {
                        echo "checked";
                    }
                    ?>> ABVD  <br /><br />
                    <input name="chemo_follow_25" type="checkbox" value="BEACOPP" id="chemo_follow_25"<?php
                    if ($dbarr['chemo_follow_25'] == 'BEACOPP') {
                        echo "checked";
                    }
                    ?>>BEACOPP
                    <input name="chemo_follow_26" type="checkbox"  value="CODOX-M" id="chemo_follow_26"<?php
                    if ($dbarr['chemo_follow_26'] == 'CODOX-M') {
                        echo "checked";
                    }
                    ?>>CODOX-M
                    <input name="chemo_follow_27" type="checkbox"  value="CODOX-M/IVAC"id="chemo_follow_27"<?php
                    if ($dbarr['chemo_follow_27'] == 'CODOX-M/IVAC') {
                        echo "checked";
                    }
                    ?>>CODOX-M/IVAC
                    <input name="chemo_follow_28" type="checkbox" value="ABVD" id="chemo_follow_28"<?php
                    if ($dbarr['chemo_follow_28'] == 'ABVD') {
                        echo "checked";
                    }
                    ?>>ALL regimen  <br /><Br />
                    <input name="chemo_follow_28_1" type="checkbox" value="Bendamustine" id="chemo_follow_28_1"<?php
                    if ($dbarr['chemo_follow_28_1'] == 'Bendamustine') {
                        echo "checked";
                    }
                    ?>>Bendamustine
                    <input name="chemo_follow_28_2" type="checkbox" value="Ibrutinib" id="chemo_follow_28_2"<?php
                    if ($dbarr['chemo_follow_28_2'] == 'Ibrutinib') {
                        echo "checked";
                    }
                    ?>>Ibrutinib <br /><br />
                    <input name="chemo_follow_29" type="checkbox"  value="Other" id="chemo_follow_29"<?php
                    if ($dbarr['chemo_follow_29'] == 'Other') {
                        echo "checked";
                    }
                    ?>>Others<br />
                    <textarea name="chemo_other_follow_29" cols="40" rows="4"  id="chemo_other_follow_29" ><?php echo $dbarr['chemo_other_follow_29']; ?></textarea> <br />
                    *Enter each <span style="padding-top:9px">chemotherapy</span> on a new line.<br>
                    ** Do not have ','(comma) in text.<br>
                    *** Do not leave blank line in text.
                    <br /><br />
                    <b><font color="#990033"> Immunotherapy</font></b> &nbsp;&nbsp;
                    <input name="immunotherapy_follow" type="radio" value="Yes"<?php
                    if ($dbarr['immunotherapy_follow'] == 'Yes') {
                        echo "checked";
                    }
                    ?> id="sub_immunotherapy_follow_yes"    />Yes  &nbsp;&nbsp;&nbsp;
                    <input name="immunotherapy_follow" type="radio" value="No"<?php
                    if ($dbarr['immunotherapy_follow'] == 'No') {
                        echo "checked";
                    }
                    ?> id="sub_immunotherapy_follow_no"   />No</span></strong>  <br /><br />
                    <div id="sub_immunotherapy_no_detail"></div>
                    <div id="sub_immunotherapy_detail">
                        <input name="sal_immun_1" id="sal_immun_1" type="checkbox" value="Rituximab"  <?php
                        if ($dbarr['sal_immun_1'] == 'Rituximab') {
                            echo "checked";
                        }
                        ?> />          Rituximab  &nbsp;&nbsp;
                        <input name="sal_immun_2" id="sal_immun_2" type="checkbox" value="Ibritumomab" <?php
                        if ($dbarr['sal_immun_2'] == 'Ibritumomab') {
                            echo "checked";
                        }
                        ?>  />          Ibritumomab  &nbsp;&nbsp;
                        <input name="sal_immun_3" id="sal_immun_3" type="checkbox" value="Alemtuzumab" <?php
                        if ($dbarr['sal_immun_3'] == 'Alemtuzumab') {
                            echo "checked";
                        }
                        ?> />          Alemtuzumab  &nbsp;&nbsp;
                        <input name="sal_immun_3_1" id="sal_immun_3_1" type="checkbox" value="Obinutuzumab" <?php
                        if ($dbarr['sal_immun_3_1'] == 'Obinutuzumab') {
                            echo "checked";
                        }
                        ?>  >    Obinutuzumab &nbsp;&nbsp;
                        <br><input name="sal_immun_3_2" id="sal_immun_3_2" type="checkbox" value="Brentuximab" <?php
                        if ($dbarr['sal_immun_3_2'] == 'Brentuximab') {
                            echo "checked";
                        }
                        ?>  >    Brentuximab &nbsp;&nbsp;
                        <br /><Br />

                        <input name="sal_immun_4" id="sal_immun_4" type="checkbox" value="Other" <?php
                        if ($dbarr['sal_immun_4'] == 'Other') {
                            echo "checked";
                        }
                        ?>  >
                        Other :&nbsp;&nbsp;
                        <input name="sal_immun_4_text" id="sal_immun_4_text" type="text" size="20"  value="<?php echo $dbarr['sal_immun_4_text']; ?>">   <br /><br />
                    </div>

                    <input name="sal_radio_follow" type="checkbox"  value="Radiotherapy" <?php
                    if ($dbarr['sal_radio_follow'] == 'Radiotherapy') {
                        echo "checked";
                    }
                    ?> id="sal_radio_follow" /> <b><font color="#990033"> Radiotherapy</font></b><br /><br />
                    <input name="sal_surgery_follow" type="checkbox"  value="Surgery" <?php
                    if ($dbarr['sal_surgery_follow'] == 'Surgery') {
                        echo "checked";
                    }
                ...
                <tr>
                    ...
                    <td>      <br />
                        <input name="stem_cell_follow"  id="stem_cell_follow_yes" type="radio" value="Yes" <?php
                        if ($dbarr['stem_cell_follow'] == 'Yes') {
                            echo "checked";
                        }
                        ?>  onclick="onaction();"   />  Yes    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                        <input name="stem_cell_follow" id="stem_cell_follow_no" type="radio" value="No"  <?php
                        if ($dbarr['stem_cell_follow'] == 'No') {
                            echo "checked";
                        }
                        ?>  onclick="onaction();"  >  No  <br /><br />
                        ...
                        <div id="stem_cell_follow_detail">
                            ...
                            <br /><br />
                            <input name="stem_cell_method" type="radio" id="stem_cell_method_autologous" value="Autologous" <?php
                            if ($dbarr['stem_cell_method'] == "Autologous") {
                                echo "checked";
                            }
                            ?> >        Autologous   <br /><br />
                            <input name="stem_cell_method" type="radio" id="stem_cell_method_allogeneic" value="Allogeneic" <?php
                            if ($dbarr['stem_cell_method'] == "Allogeneic") {
                                echo "checked";
                            }
                            ?>   />        Allogeneic
                                ...
                                <table width="500" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <input name="conditioning" type="radio" id="conditioning1" value="Myeloablative"<?php
                                            if ($dbarr['conditioning'] == 'Myeloablative') {
                                                echo "checked";
                                            }
                                            ?>>
                                            Myeloablative  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input name="conditioning" type="radio"  id="conditioning2" value="Non-myeloablative" <?php
                                            if ($dbarr['conditioning'] == 'Non-myeloablative') {
                                                echo "checked";
                                            }
                                            ?>>
                                            ...
                                            <b> Donor</b>  <br /><br />
                                            <input name="donor_follow" type="radio"  id="donor_follow1" value="HLA identical sibling" <?php
                                            if ($dbarr['donor_follow'] == 'HLA identical sibling') {
                                                echo "checked";
                                            }
                                            ?> > HLA identical sibling <br /><br />
                                            <input name="donor_follow" type="radio"  id="donor_follow2" value=" Matched unrelated donor" <?php
                                            if ($dbarr['donor_follow'] == ' Matched unrelated donor') {
                                                echo "checked";
                                            }
                                            ?> >  Matched unrelated donor  <br /><br />
                                            <input name="donor_follow" type="radio"  id="donor_follow3" value="Haploidentical sibling" <?php
                                            if ($dbarr['donor_follow'] == 'Haploidentical sibling') {
                                                echo "checked";
                                            }
                                            ?> > Haploidentical sibling  <br /><br />
                                            <input name="donor_follow" type="radio"  id="donor_follow4" value="Other" <?php
                                            if ($dbarr['donor'] == 'Other') {
                                                echo "checked";
                                            }
                                            ?> > Other  <br /><br />
                                            <table width="500" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left"><br />
                        ...
                        <input name="status_follow" type="radio" value="Alive" id="status_follow_alive"  <?php
                        if ($dbarr['status_follow'] == 'Alive') {
                            echo "checked";
                        }
                        ...
                        <div id="alive">
                            <table width="300" border="0" cellpadding="0" cellspacing="0" >
                                <tr>
                                    <td>
                                        <input name="alive_status" id="alive_status1" type="radio" value="Remission"   <?php
                                        if ($dbarr['alive_status'] == 'Remission') {
                                            echo "checked";
                                        }
                                        ?>  />    Remission  &nbsp;&nbsp;&nbsp;
                                        <input name="alive_status"  id="alive_status2" type="radio" value="No remission"  <?php
                                        if ($dbarr['alive_status'] == 'No remission') {
                                            echo "checked";
                                        }
                                        ?> />  No remission
                                    </td>
                        ...
                        <br /><br />
                        <input name="status_follow" type="radio" value="Dead" id="status_follow_dead" <?php
                        if ($dbarr['status_follow'] == 'Dead') {
                            echo "checked";
                        }
                                        ...
                                        <table width="100%" border="0" cellspacing="5" cellpadding="0">
                                            ...
                                            <tr>
                                                <td width="33%" align="left" >
                                                    <input name="cause_of_dead" id="cause_of_dead1" type="radio" value="Infection"<?php
                                                    if ($dbarr['cause_of_dead'] == 'Infection') {
                                                        echo "checked";
                                                    }
                                                    ?> >         Infection</td>
                                                <td width="33%" align="left" >
                                                    <input name="cause_of_dead" id="cause_of_dead2" type="radio" value="Progression"<?php
                                                    if ($dbarr['cause_of_dead'] == 'Progression') {
                                                        echo "checked";
                                                    }
                                                    ?> >        Progression</td>
                                                <td align="left">
                                                    <input name="cause_of_dead" id="cause_of_dead3" type="radio" value="Hemorrhage"<?php
                                                    if ($dbarr['cause_of_dead'] == 'Hemorrhage') {
                                                        echo "checked";
                                                    }
                                                    ?> >           Hemorrhage</td>
                                            </tr>
                                                    ...
                                                    <table width="400" border="0" cellpadding="0" cellspacing="0" >
                                                        <tr>
                                                            <td width="60" valign="top" align="left">
                                                                <input name="cause_of_dead" id="cause_of_dead4"  type="radio" value="Other"<?php
                                                                if ($dbarr['cause_of_dead'] == 'Other') {
                                                                    echo "checked";
                                                                }
                                                                ?>>    Other</td>
                                                            <td><input name="cause_of_dead_other" id="cause_of_dead_other" type="text"  size="40" value="<?php echo $dbarr['cause_of_dead_other']; ?>" ></td>
                                                        </tr>
                                                    </table>            </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <input name="lymphoma_status" id="lymphoma_status1" type="radio" value="Remission" <?php
                                                    if ($dbarr['lymphoma_status'] == 'Remission') {
                                                        echo "checked";
                                                    }
                                                    ?> >            Remission</td>
                                                <td align="left">
                                                    <input name="lymphoma_status" id="lymphoma_status2" type="radio" value="No remission"<?php
                                                    if ($dbarr['lymphoma_status'] == 'No remission') {
                                                        echo "checked";
                                                    }
                                                    ?> >            No remission</td>
                                                <td  align="left">
                                                    <input name="lymphoma_status"  id="lymphoma_status3" type="radio" value="Indeterminate" <?php
                                                    if ($dbarr['lymphoma_status'] == 'Indeterminate') {
                                                        echo "checked";
                                                    }
                                                    ?> >           Indeterminate</td>
                                            </tr>
                        ...
                        <input name="status_follow" type="radio" id="status_follow3" value="Loss to follow-up" <?php
                        if ($dbarr['status_follow'] == "Loss to follow-up") {
                            echo "checked";
                        }
                ...
                <tr>
                    <th colspan="4" align="center">
                        ...
                        <button  type="submit" id="drafts" name="drafts" value="Update Data"  />Save drafts</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input name="Submit2" type="button" class="button" value="Cancel" onClick="window.history.back();">&nbsp;&nbsp;&nbsp;&nbsp;<br />
