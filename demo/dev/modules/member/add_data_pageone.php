...
///////////////////
            ...
            $sqlCode = "select * from " . TB_MEMBER . " where user='" . $_SESSION['login_true'] . "'";
            $result = mysql_query($sqlCode) or die("Err Can not to result");
...
//  เพิ่มค่าบวกหนึ่งของหมายเลข job                            
                            $sqlJob = "select MAX(id)+1 as total from " . TB_ADD_DATA . " ";
                            $resultJob = mysql_query($sqlJob);
                            $getJobNumber = mysql_fetch_row($resultJob);
                            $code_id = $getJobNumber['0']; // นำค่า id มาเพิ่มให้กับค่า   + 1
                            $registryNumber = $codehos . $code_id;
                            ?>
                            <th align="left"  colspan="3">
                                <br /><strong><input type="hidden" name="centre"  value="<?php echo $registryNumber; ?>"  size="5"  readonly="readonly"/> <?php echo $registryNumber; ?></strong>
                        ...
                        <tr>
                            <th align="left">ID :</th>
                            <td colspan="3" > <br />
                                <input type="password" size="10"  name="id_card" id="id_card1" maxlength="13"   onkeyup="onaction();
                                            checkid();" >   &nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            ...
                            <td colspan="3" > <br />
                                <input type="password" size="10"  name="id_card_confirm"  id="id_card_confirm1" maxlength="13"  onkeyup="onaction();
                                            checkid();"> &nbsp;&nbsp;   กรุณากรอกเป็นตัวเลข(Ex: 1522222222xx)  <font color="#FF0000">**ถ้าไม่รู้ให้ใส่เครื่องหมาย '-'</font><br /><br />
                        ...
                        <tr>
                            <th align="left">HN :</th>
                            <td colspan="3" > <br />
                                <input type="password" size="10"  name="hn" maxlength="20" id="hn1" onkeyup="onaction();
                                            checkhn();"> &nbsp;&nbsp;(Example: 5-19-42/48 = 5194248)<br /><br /></td>
                        </tr>
                        <tr>
                            <th align="left">Confirm HN :</th>
                            <td colspan="3" > <br />
                                <input type="password" size="10"  name="hn_confirm" maxlength="20" id="hn2"  onkeyup="onaction();
                                            checkhn();"> &nbsp;&nbsp;(Example: 5-19-42/48 = 5194248)<br /><br />
                        ...
                        <tr>
                            ...
                            <td colspan="3" > <br />
                                <input type="password" size="10"  name="pathology" id="pathology"  onkeyup="onaction();
                                            checkpathology();">  (Example: SP47-0007/47 = SP47000747)<br /><br /></td>
                        </tr>
                        <tr>
                            <th align="left">Confirm Pathology No.:</th>
                            <td colspan="3" > <br />
                                <input type="password" size="10"  name="pathology_confirm"  id="pathology_confirm" onkeyup="onaction();
                                            checkpathology();">  (Example: SP47-0007/47 = SP47000747)<br /><br />
                        ...
                        <tr>
                            ...
                            <td colspan="3" > <br />
                                <table width="100%" border="0" align="center">
                                    <tr>
                                        <td>   <input type="radio" name="ann_arbor" id="ann_arbor1"   value="I" onclick="onaction();
                                                    checkage();" />   I           </td>
                                        <td>    <input type="radio" name="ann_arbor"  id="ann_arbor2"  value="II"  onclick="onaction();
                                                    checkage();"/>   II   </td>
                                    </tr>
                                    <tr>
                                        <td><input type="radio" name="ann_arbor" id="ann_arbor3"   value="III" onclick="onaction();
                                                    checkage();" />   III </td>
                                        <td><input type="radio" name="ann_arbor" id="ann_arbor4"  value="IV" onclick="onaction();
                                                    checkage();" />   IV</td>
                                    </tr>
                                    <tr>
                                        <th><b>Symptom</b></th>
                                        <td><br /><input type="radio" name="symptom_ann"  value="A" id="symptom_ann1" onclick="onaction();" >  A  <br /><br />
                                            <input type="radio" name="symptom_ann"  value="B" id="symptom_ann2" onclick="onaction();" > B <br /><br />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="3" > <br />
                                <input type="radio"   name="per_ecog"  value="0" id="per_ecog0"  onclick="onaction();
                                            checkage();"> 0  &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio"   name="per_ecog"  value="1" id="per_ecog1" onclick="onaction();
                                            checkage();">  1 &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio"   name="per_ecog"  value="2" id="per_ecog2" onclick="onaction();
                                            checkage();"> 2 &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio"   name="per_ecog"  value="3" id="per_ecog3" onclick="onaction();
                                            checkage();" > 3 &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio"   name="per_ecog"  value="4" id="per_ecog4" onclick="onaction();
                                            checkage();"> 4  &nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" > <br />
                                <input type="radio"   name="ldh" id="ldh1"  value="Normal" onclick="onaction();
                                            checkage();"  >  Normal  &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio"   name="ldh" id="ldh2"  value="High"  onclick="onaction();
                                            checkage();">  High
                                <br /><br />
                                <input type="text"   name="micro"   value=""   >  (U/L) <br /><br />
                        ...
                        <tr>
                            ...
                            <td><br /><input type="text"   name="hemoglobin"  id="hemoglobin"  value=""   >  Hemoglobin(g/dl) <br /><br />
                                ...
                                <input type="text"   name="luc" id="luc"  value=""   >   LUC(%) ( large undifferentiated or unidentified cell)  <br /><br />
                        ...
                        <tr>
                            ...
                            <td><br /><b>HBsAg</b>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <b>Anti-HBsAb </b>
                                <input type="radio"   name="hep_b_anti_hbsab"   value="posiive"   >  posiive  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            ...
                            <td><br /><b> Anti-HCV</b>  &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio"   name="hep_c_anti_hcv"   value="posiive"   >  posiive  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
