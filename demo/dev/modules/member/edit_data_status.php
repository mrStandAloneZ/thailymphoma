...
//	$id= $_POST["id"];
//	$status_3mo= $_POST["status_3mo"];
//	$status = $_POST["status"];
	//	$id = htmlspecialchars($id) ;
	//	$status_3mo = htmlspecialchars($status_3mo) ;
		$status  =  "3";

$result = mysql_query( "update ".TB_ADD_DATA." SET  status_3mo='$status' ,edit_date='$edit_date' ,edit_month='$edit_month' ,edit_year='$edit_year',edit_member='$edit_member'   where id='$id' " ) or die ("ไม่สามารถบันทึกข้อมูลได้ครับ กรุณาตรวจสอบข้อมูลให้ถูกต้อง");	
	echo $status;
