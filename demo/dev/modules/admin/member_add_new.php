...
$result = mysql_query("insert into ".TB_MEMBER." (member_id,user,password,fullname,sex,age,hospital_name,codehos,address_office,work,tel_office,tel,email)

values('$member_id','$user','$password','$fullname','$sex','$age','$hospital_name','$codehos','$address_office','$work','$tel_office','$tel','$email')")  or die("ไม่สามารถบันทึกข้อมูลได้ โปรดตรวจสอบความผิดพลาด หรือติดต่อ ผู้ดูแลโปรแกรม");
if($result) {
