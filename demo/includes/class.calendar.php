...
class Calendar
{
    ...
    */
    function getMonthHTML($m, $y, $showYear = 1)
    {
    	...
    	$s .= "<tr>\n";
    	$s .= "<td align=\"center\" valign=\"top\" class=\"calendarHeader\">" . (($prevMonth == "") ? "&nbsp;" : "<a href=\"$prevMonth\"><img src=\"images/icon/Previous.png\" /></a>")  . "</td>\n";
    	$s .= "<td align=\"center\" valign=\"top\" class=\"calendarHeader\" colspan=\"5\">$header</td>\n"; 
    	$s .= "<td align=\"center\" valign=\"top\" class=\"calendarHeader\">" . (($nextMonth == "") ? "&nbsp;" : "<a href=\"$nextMonth\"><img src=\"images/icon/Next.png\" /></a>")  . "</td>\n";
    	$s .= "</tr>\n";
    	...
    	while ($d <= $daysInMonth)
    	{
    	    ...
    	    for ($i = 0; $i < 7; $i++)
    	    {
    	        ...
    	        if ($d > 0 && $d <= $daysInMonth)
    	        {
    	            ...
    	            //Date link here
					$s .= (($link == "") ? $d : "<a href=\"".$link['link']."\" onclick=\"return hs.htmlExpand(this, { contentId: 'highslide-html', objectType: 'iframe', objectWidth: 700, objectHeight: 500} )\" class=\"highslide\" onMouseover='ddrivetip(\"".$link['title']."\",\"\", 250)'; onMouseout='hideddrivetip()'><B>$d</B></a>");
    	        }
    	        else
    	        {
    	            $s .= "&nbsp;";
    ...
    */
    function getYearHTML($year)
    {
        ...
        $s .= "<tr>";
    	$s .= "<td align=\"center\" valign=\"top\" align=\"left\">" . (($prev == "") ? "&nbsp;" : "<a href=\"$prev\"><img src=\"images/icon/Previous.png\" /></a>")  . "</td>\n";
        $s .= "<td class=\"calendarHeader\" valign=\"top\" align=\"center\">" . (($this->startMonth > 1) ? $Syear . " - " . ($Syear + 1) : $Syear) ."</td>\n";
    	$s .= "<td align=\"center\" valign=\"top\" align=\"right\">" . (($next == "") ? "&nbsp;" : "<a href=\"$next\"><img src=\"images/icon/Next.png\" /></a>")  . "</td>\n";
        $s .= "</tr>\n";
        $s .= "<tr>";
    ...
    */
	...
	var $dayNames = array("<img src=\"images/icon/calendar_s.gif\" />", "<img src=\"images/icon/calendar_m.gif\" />", "<img src=\"images/icon/calendar_t.gif\" />", "<img src=\"images/icon/calendar_w.gif\" />", "<img src=\"images/icon/calendar_th.gif\" />", "<img src=\"images/icon/calendar_f.gif\" />", "<img src=\"images/icon/calendar_sa.gif\" />");
...
class MyCalendar extends Calendar
{
    ...
    function getDateLink($day, $month, $year)
    {
        ...
        if ($arr[event][id])
        {
            $link['link'] = "index.php?name=calendar&file=view&id=".$arr[event][id]."";
