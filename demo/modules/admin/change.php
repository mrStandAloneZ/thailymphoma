...
?>
&nbsp;&nbsp;&nbsp;<h1>&nbsp;&nbsp;&nbsp;&nbsp;ตารางการแลกเปลี่ยนเวรทั้งหมด/การจ้างพยาบาลพิเศษทั้งหมด</h1>
<TABLE width="95%" align=center cellSpacing=0 cellPadding=0 border=0>
				<TR>
					<TD>
    <p>
    <div align="right"><B><IMG SRC="images/icon/icon_folder.gif" WIDTH="16" HEIGHT="16" BORDER="0" ALIGN="absmiddle"> <A HREF="admin.php?name=admin&file=change">รายการทั้งหมด</A> &nbsp;&nbsp;&nbsp; <IMG SRC="images/icon/icon_add.gif" WIDTH="16" HEIGHT="16" BORDER="0" ALIGN="absmiddle"> <A HREF="admin.php?name=admin&file=change_post">ตั้งหัวข้อใหม่</A></B>&nbsp;&nbsp;</div>
...
<form name="form1" method="post" action="admin.php?name=admin&file=search">
  <table><tr><td><strong> จากฟีลด์</strong>
    <select name="fields">
