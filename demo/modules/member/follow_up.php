...
?>
    ...
    <tr>
     ...
     <td width="44%" align="center" colspan="2"><br />
      <input name="chemotherapy_follow" id="chemotherapy_follow_yes" type="radio" value="Chemotherapy"  <?php if ($dbarr['chemotherapy_follow'] == "Chemotherapy") {
    echo "checked";
}
?>  onclick="onaction();" /> Yes  &nbsp;&nbsp;&nbsp;
      <input name="chemotherapy_follow" id="chemotherapy_follow_no" type="radio" value="No Chemotherapy" <?php if ($dbarr['chemotherapy_follow'] == "No Chemotherapy") {
    echo "checked";
}
?>  onclick="onaction();" /> No
      <br /><br />
...
<tr>
  ...
  <td align="center"> <br />&nbsp;
    ...
    <input name="immunotherapy_follow"   id="immunotherapy_follow_yes" type="radio" value="Immunotherapy"  <?php if ($dbarr['immunotherapy_follow'] == 'Immunotherapy') {
    echo "checked='checked'";
}
?>   onclick="onaction();"  />  Yes &nbsp;&nbsp;&nbsp;
    <input    name="immunotherapy_follow"  id="immunotherapy_follow_no" type="radio" value="Immunotherapy_no"    <?php if ($dbarr['immunotherapy_follow'] == 'Immunotherapy_no') {
   echo "checked='checked'";
}
?>  onclick="onaction();"  />  No
    <br /><br />
...
?> onclick="onaction();"  />  Rituximab (Mark all that apply)  <br /><br />
          ...
          <div  id="immun_select_follow1_show">
            <table width="500" border="0" cellpadding="0" cellspacing="0" >
              <tr>
                <td><br />
                 <input name="immun_select_follow_sub[]" id="rituximab_1" type="checkbox"  value="Induction" <?php if (strlen(strstr($dbarr['immun_other_text'], "Induction")) > 0) {
    echo "checked";
}
...
<tr>
 ...
 <td align="center" colspan="2"> <br />&nbsp;
  <input name="radiotherapy_follow" id="radiotherapy_follow_yes" type="radio" value="Radiotherapy"  <?php if ($dbarr['radiotherapy_follow'] == 'Radiotherapy') {
    echo "checked";
}
?>   onclick="onaction();"  />  Yes &nbsp;&nbsp;&nbsp;
  <input name="radiotherapy_follow" id="radiotherapy_follow_no" type="radio" value="Radiotherapy_no"  <?php if ($dbarr['radiotherapy_follow'] == 'Radiotherapy_no') {
    echo "checked";
}
?>   onclick="onaction();"  />  No
  <br /><br />
...
<tr>
 ...
 <td align="center" ><br />&nbsp;
   ...
   <input type="radio" name="surgery_follow" id="surgery_follow_yes"  value="yes"  <?php if ($dbarr['surgery_follow'] == "yes") {
    echo "checked";
}
?>  onclick="onaction();"  />  Yes &nbsp;&nbsp;&nbsp;

  <input name="surgery_follow" id="surgery_follow_no" type="radio" value="no"     <?php if ($dbarr['surgery_follow'] == "no") {
   echo "checked";
}
...
<tr>
 <th align="center" > <br />
  ...
  <br /><br /></th>
  <td align="center"><input name="no_treatment_follow"  id="no_treatment_follow" type="checkbox" value="No (including observation)"  <?php if ($dbarr['no_treatment_follow'] == 'No (including observation)') {
    echo "checked";
}
