...
//	$status = $_POST["status"];
		...
		$status_6mo = htmlspecialchars($status_6mo) ;
		$status  =  "3";

$result = mysql_query( "update ".TB_ADD_DATA." SET  status_6mo='$status' " ) or die ("ไม่สามารถบันทึกข้อมูลได้ครับ กรุณาตรวจสอบข้อมูลให้ถูกต้อง");	
	echo $status;
