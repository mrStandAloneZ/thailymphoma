...
if ($search != '') {
  ...
  if($_GET["nx5"]){$nx5=$_GET["nx5"]*50;}else{$nx5=0;}
	  ?>
      ...
      for($i=1;$i<=$num5;$i++){$inx++;
       ?>
       <td width="25px" class="chbg" onclick="window.location='?nx5=<?=$inx?>'" style="cursor:pointer;"><font color="#ffffff"><?=$i?></font></td>
      <?php } ?>
    </tr></table>
