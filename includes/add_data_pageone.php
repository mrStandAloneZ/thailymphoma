...
//  เพิ่มค่าบวกหนึ่งของหมายเลข job
    ...
    $ss = "select * from " . TB_ADD_DATA . " WHERE codehos='$codehos'  and  id = (select max(id) from ".TB_ADD_DATA.") as idrun";
    $aa = mysql_query($ss);
	    $dbid = mysql_fetch_row($aa);
    ...
    <th align="left"  colspan="3">
     <br /><strong><input type="hidden" name="centre"  value="<?php echo $codehos . $dbid["id"]; ?>"  size="5"  readonly="readonly"/>*<?php echo $codehos . $bb; ?></strong>
