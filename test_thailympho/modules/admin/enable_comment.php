...
<?
	if(CheckLevel($_SESSION['admin_user'],"change_edit")){
		...
		$ProcessOutput .= "<A HREF=\"admin.php?name=admin&file=change_read&id=".$_GET[id]."\"><B>กลับหน้าแสดงผล</B></A>";
