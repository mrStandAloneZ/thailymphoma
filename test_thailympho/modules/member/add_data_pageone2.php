...
//  url=index.php ¤ÓÊÑè§¹Õé¨ÐãËéä»Ë¹éÒ·Õè¨ÐµéÍ§¡ÃÍ¡ user,pwd ¶éÒÍÂÙèâ¿Åìà´ÍÃìÍ×è¹ãËéàÃÕÂ¡ãËé¶Ù¡¹Ð¤ÃÑº
    echo "
  <div id='wrapper'>
   <div id='logo'>
...
///////////////////
    ...
    ?>
       ...
       <?php //   code »¯Ô·Ô¹ÀÒÉÒä·Â  á»Å§ ¤È à»ç¹ ¾È à»ç¹¡ÒÃàÃÕÂ¡ä¿ÅìÁÒãªé§Ò¹                        ?>
 ...
 font-size: 15px;
  color:#18222e;
       ...
       <form id="checkForm" name="checkForm" method="post" action="?name=member&file=member_add_pageone"  onSubmit="return check()" enctype="multipart/form-data" >
		 ...
		 <tr><td style="padding-left:35px;padding-top:15px">
          <h1>Insert Lymphoma Registry</h1>
		  </td></tr></table>
          <p>
           <meta http-equiv="Content-type" content="text/html;charset=tis-620" />
           <center><table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" >

             <tr bgcolor="#F4F4F4">
              <th align="left" width="33%">Date of record: </th>
              <td colspan="3"><br />
               ÇÑ¹·Õè <input  type="hidden" name="dateofrecord"  value="<?php echo $date_today1 . '-' . $date_todaymonth . '-' . $date_todayone; ?>"  size="10"  readonly="readonly"/><b><?php echo $date_todayone . '-' . $date_todaymonth . '-' . $date_today1; ?></b> (¾.È.)<br /><br />
             </td>
           </tr>
           <tr bgcolor="#F4F4F4" >
            <th align="left" width="33%"><br /><strong>Code : </strong><br /></th>
            <?php
//  à¾ÔèÁ¤èÒºÇ¡Ë¹Öè§¢Í§ËÁÒÂàÅ¢ job
     $sql = "select * from " . TB_ADD_DATA . " order by id";
    $result = mysql_query($sql);
    $num_result = mysql_num_rows($result);
    $dbarr = mysql_fetch_row($result);
    $code_id = $dbarr['0'] + 1; // ¹Ó¤èÒ id ÁÒà¾ÔèÁãËé¡Ñº¤èÒ   + 1
    $job_in = "$num_result"+1;
    $code_id = "$job_in"; //

    ?>
				<?php // ¹Ñº¨Ó¹Ç¹ãº§Ò¹¢Í§áµèÅÐ Ã¾. (ÊèÇ¹¹Õé¨ÐäÁè¢Öé¹µèÍ¡Ñ¹ )
    ...
    $bb = $bb + 1; // àÅ¢·Õèãº§Ò¹¢Í§ Ã¾ ¹Ñé¹æ
    ?>
    <th align="left"  colspan="3">
     <br /><strong><input type="hidden" name="centre"  value="<?php echo $codehos . $dbid["idrun"]; ?>"  size="5"  readonly="readonly"/>*<?php echo $codehos.$substr ?></strong>

     <br /><br /></th>
   </tr>
   <tr bgcolor="#F4F4F4" >
    <th align="left" width="33%">Patient Initials :</th>
    <td colspan="3"><br /> <input type="text" name="patient_initials" size="2"  maxlength="2"  id="patient_initials"  style="text-transform: uppercase" onkeyup="onaction();" /> <b>** ¡ÃØ³Ò¡ÃÍ¡à»ç¹ÀÒÉÒÍÑ§¡ÄÉµÑÇ¾ÔÁ¾ìãË­è(BO)</b><br /><br />     </td>
  </tr>
  <tr bgcolor="#F4F4F4" >
  ...
  <tr bgcolor="#F4F4F4" >
    ...
    <td colspan="3" > <br />
      ...
      ¡ÃØ³Ò¡ÃÍ¡à»ç¹µÑÇàÅ¢(Ex: 1522222222xx)   <font color="#FF0000">**¶éÒäÁèÃÙéãËéãÊèà¤Ã×èÍ§ËÁÒÂ '-'</font>
      <br /><br />
    </td>
  </tr>
  <tr bgcolor="#F4F4F4" >
    ...
    <td colspan="3" > <br />
     <input type="password" size="10"  name="id_card_confirm"  id="id_card_confirm1" maxlength="13"  onkeyup="onaction();checkid();"> &nbsp;&nbsp;   ¡ÃØ³Ò¡ÃÍ¡à»ç¹µÑÇàÅ¢(Ex: 1522222222xx)  <font color="#FF0000">**¶éÒäÁèÃÙéãËéãÊèà¤Ã×èÍ§ËÁÒÂ '-'</font><br /><br />
	 
     <span id="alertid" hidden><font color="#ff0000">¡ÃØ³Ò¡ÃÍ¡¢éÍÁÙÅãËéµÃ§¡Ñ¹</font></span>
   </td>
 </tr>
 <tr bgcolor="#F4F4F4" >
  <th align="left">HN :</th>
  ...
  <tr bgcolor="#F4F4F4" >
    ...
    <td colspan="3" > <br />
      ...
      <span id="alerthn" hidden><font color="#ff0000">¡ÃØ³Ò¡ÃÍ¡¢éÍÁÙÅãËéµÃ§¡Ñ¹</font></span>
    </td>
  </tr>
  <tr bgcolor="#F4F4F4" >
...
<tr bgcolor="#F4F4F4" >
  <th align="left">Date of biopsy :</th>
  <td colspan="3" > <br />
   <input type="text" name="date_bio_report" id="date_bio_report"  size="10" onkeyup="onaction();"/> (dd-mm-¾.È.(2500))
   
    <button type="button" onclick="calyear()"  style="background-color:#7a5037;color:#FFFFFF;cursor:pointer;width:80px;">cal</button><br />
	
	<table width="160px"  style="border-radius: 6px;"      height="25px"  bgcolor="#cccccc"><tr><td><b><span id="yearold"></span></b></td></tr></table>
	
	<input type="hidden" id='input_yearold' value=""><br />
      <font color="#FF0000"><b>¡ÃØ³Ò¡´ cal à¾×èÍ¤Ó¹Ç³ÍÒÂØ</b></font>
    ...
    <tr bgcolor="#F4F4F4" >
      ...
      <td colspan="3" > <br />
        <select name="province" id="province" style="width:150px;"  onchange="onaction();" >
         <option  value="">¡ÃØ³ÒàÅ×Í¡¨Ñ§ËÇÑ´</option>
 ...
 <tr bgcolor="#F4F4F4" >
  ...
  <tr bgcolor="#F4F4F4" >
    ...
    <td colspan="3" > <br />
     ...
     <span id="alertpat" hidden><font color="#ff0000">¡ÃØ³Ò¡ÃÍ¡¢éÍÁÙÅãËéµÃ§¡Ñ¹</font></span>
   </td>
 </tr>
 <tr bgcolor="#F4F4F4" >
...
<table><tr><td>
   <select name="biopsy_site" id="biopsy_site" style="width:150px;" onchange="onaction();fc_oth_biopsy();">
   ...
   <input type="text" name="oth_biopsy"  id="oth_biopsy" size="70px;"/>
 </td></tr>
 </table>
...
var oth_biopsy =  document.getElementById("oth_biopsy");
 ...
 function fc_oth_biopsy(){
 //alert(oth_biopsy.value);
      if(oth_biopsy.value=="Others"){
...
<tr bgcolor="#F4F4F4" >
  ...
  <td colspan="3" > <br />
    ...
    <div id="extra_site">
      ...
      <br />
      <input type="checkbox" name="ext_lung"   value="Lung/Pleura"   id="ext_lung"onclick="checkage();" >  Lung/Pleura &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php //******   Â¿Ã”Ã…Â´Ã¬Â·Ã•Ã¨Ã Â¾Ã”Ã¨ÃÂ¢Ã–Ã©Â¹ÃÃ’Ã£Ã‹ÃÃ¨  ?>
...
<tr bgcolor="#F4F4F4" >
 ...
 <tr bgcolor="#F4F4F4" >
   ...
   <td><br />
    <input type="text"   name="hemoglobin"  id="hemoglobin"  value=""   >  Hemoglobin(g/dl) <br /><br />
...
<tr bgcolor="#F4F4F4" >
  ...
  <td colspan="3"><br />
    ...
    <div>
      ...
      <span id="age_ipi">
      (¡ÃØ³Ò¡ÃÍ¡¢éÍÁÙÅÇÑ¹à¡Ô´ áÅÐ ¡´»ØèÁ¤Ó¹Ç³)
      </span>
    </div><br>
    <div>
      <span>
    ...
    <div id='ext_div'>
      ...
      <span id="ext_ipi">
      (¡ÃØ³Ò¡ÃÍ¡¢éÍÁÙÅ Extranodal sites)
      </span>
    </div><br>
    <div>
      <span>
...
<tr bgcolor="#F4F4F4" >
 ...
 <td colspan="4" align="center">
   ...
   <input name="Submit2" type="button" class="button" value="Cancel" onClick="window.history.back();" style="background-color:#7a5037;color:#FFFFFF;cursor:pointer;width:120px;">&nbsp;&nbsp;&nbsp;&nbsp;
   <br /><br />
   <font color="#CC3300">* ¡Ã³Õ·Ó¡ÒÃ Save ¢éÍÁÙÅ»¡µÔ¨Óà»ç¹¨ÐµéÍ§¡ÃÍ¡¢éÍÁÙÅãËé¤Ãº·Ø¡ªèÍ§¤èÐ !</font>
   <br />
...
check_getsave();
 var myVar = setInterval(check_getsave, 3000);
	 ...
	 var  txtc2= "";
	 		        ...
	 		        var chkd1= document.checkForm.id_card1.value;
					var chkd2= document.checkForm.id_card_confirm1.value;
					
					
					var chkdd1= document.checkForm.hn1.value;
					var chkdd2= document.checkForm.hn2.value;
					
					if(chkd1==chkd2){$txtc1="xxxx";}else{$txtc1="";}
					if(chkdd1==chkdd2){$txtc2="xxxx";}else{$txtc2="";}
		 ...
		 var x1=document.checkForm.ext_none.checked;
		 var x2=document.checkForm.ext_wal.checked;
		 var x3=document.checkForm.ext_sin.checked;
		 var x4=document.checkForm.ext_sal.checked;
		 var x5=document.checkForm.ext_thy.checked;
		 var x6=document.checkForm.ext_eye.checked;
		 var x7=document.checkForm.ext_lung.checked;
		 var x8=document.checkForm.ext_breast.checked;
		 var x9=document.checkForm.ext_stomach.checked;
		 var x10=document.checkForm.ext_small.checked;
		 var x11=document.checkForm.ext_testis.checked;
		 var x12=document.checkForm.ext_brain.checked;
		 var x13=document.checkForm.ext_liver.checked;
		 var x14=document.checkForm.ext_large.checked;
		 var x15=document.checkForm.ext_bone.checked;
		 var x16=document.checkForm.ext_spleen.checked;
		 var x17=document.checkForm.ext_skin.checked;
		 var x18=document.checkForm.ext_other.checked;
		
		// var x19=document.checkForm.ext_other_text.value;
		 if(x1!=false && x2!=false && x3!=false && x4!=false && x5!=false && x6!=false && x7!=false && x8!=false && x9!=false && x10!=false && x11!=false && x12!=false && x13!=false && x14!=false && x15!=false && x16!=false && x17!=false && x18!=false)
		 { x="";}else{ x="xxx"; }
		...
		var t1= document.checkForm.patient_initials.value;
		var t2= document.checkForm.sex.value;
		var t3= document.checkForm.id_card.value;
		var t4= document.checkForm.id_card_confirm.value;
		var t5= document.checkForm.hn.value;
		var t6= document.checkForm.hn_confirm.value;
		var t7= document.checkForm.date_of_birth.value;
		var t8= document.checkForm.date_bio_report.value;
		var t9= document.checkForm.province.value;
		var t10= document.checkForm.payment.value;
		var t11= document.checkForm.pathology.value;
		var t12= document.checkForm.pathology_confirm.value;
		var t13= document.checkForm.biopsy_site.value;
		var t14= document.checkForm.type.value;
		var t15= document.checkForm.ann_arbor.value;
		var t16= document.checkForm.symptom_ann.value;
		var t17= document.checkForm.per_ecog.value;
		var t18= document.checkForm.ldh.value;
		var t19= document.checkForm.micro.value;
		var t20= document.checkForm.upper.value;
		var t21= document.checkForm.hemoglobin.value;
		var t22= document.checkForm.mcv.value;
		var t23= document.checkForm.wbc.value;
		var t24= document.checkForm.platelet.value;
		var t25= document.checkForm.neutrophil.value;
		var t26= document.checkForm.lymphocyte.value;
		var t27= document.checkForm.monocyte.value;
		var t28= document.checkForm.eosinophil.value;
		var t29= document.checkForm.basophil.value;
		var t30= document.checkForm.luc.value;
		var t31= document.checkForm.blast_lymphoma.value;
		var t32= document.checkForm.hep_b_hbsag.value;
		var t33= document.checkForm.hep_b_anti_hbcab.value;
		var t34= document.checkForm.hep_b_anti_hbsab.value;
		var t35= document.checkForm.hiv_positive.value;
		var t36= document.checkForm.bulky.value;
		
		       if((t1!="" && t2!="" && t3!="" && t4!="" && t5!="" && t6!="" && t7!="" && t8!="" && t9!="" && t10!="" && t11!="" && t12!="" && t13!="" && t14!="" && t15!="" && t16!="" && t17!="" && t18!="" && t19!="" && t20!="" && t21!="" && t22!="" && t23!="" && t24!="" && t25!="" && t26!="" && t27!="" && t28!="" && t29!="" && t30!="" && t31!="" && t32!="" && t33!="" && t34!="" && t35!=""  && t36!="" && x!="" && txtc1!="" && $txtc2!="")){
  ...
  function calyear(){
    ...
    if(birth != "" && date_bio_report != ""){
      ...
      document.getElementById('yearold').innerHTML = "¡ÃØ³ÒãÊèÇÑ¹à´×Í¹»Õà¡Ô´¡èÍ¹¤Ó¹Ç³";
    }
  }
...
alert("¡ÃØ³Ò¡ÃÍ¡ Patient Initials") ;
...
alert("¡ÃØ³ÒàÅ×Í¡ Ann Arbor stage ") ;
return false ;
}
