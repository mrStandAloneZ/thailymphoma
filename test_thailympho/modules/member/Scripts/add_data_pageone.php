...
<tr bgcolor="#F4F4F4" >
  ...
  <td colspan="3" > <br />
   <input type="text" name="date_bio_report" id="date_bio_report"  size="10" onkeyup="onaction();"/> (dd-mm-พ.ศ.(2500))<br />
   
    <button type="button" onclick="calyear()"  style="background-color:#7a5037;color:#FFFFFF;cursor:pointer;width:80px;">cal</button><br /><b><span id="yearold"></span><input type="hidden" id='input_yearold' value=""><br /><br />
