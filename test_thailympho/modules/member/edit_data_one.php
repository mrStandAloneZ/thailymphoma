...
<div id="center">
		 ...
		 <tr bgcolor="#F4F4F4" ><td style="padding-left:35px;padding-top:15px">
  ...
  <center>
    ...
    <table width="100%" border="0" align="center">
      <tr bgcolor="#F4F4F4" >
        ...
        <td align="left" width="68%"><br /><strong><input type="hidden"  name="centre"  value="<?php echo $dbarr['codehos']; ?>"  size="10"  readonly="readonly"/> *<?php echo $dbarr['centre']; ?></strong></br></br></td>
...
<tr bgcolor="#F4F4F4" >
  ...
  <tr bgcolor="#F4F4F4" >
    ...
    <th align="left" width="68%" colspan="3"><br /><strong><input type="hidden" name="centre"  value="<?php echo $dbarr['centre']; ?>"  size="10"  readonly="readonly"/><?php echo $dbarr['codehos']; ?>
    </strong><br /><br /></th>
...
?> onclick="onaction();"  >  Female  &nbsp;&nbsp;&nbsp;&nbsp;
 ...
 $who_s = trim($dbarr['who_sub']);
  $work_s = trim($dbarr['work_sub']);
    $other_s = trim($dbarr['other_type']);
?>
...
<tr bgcolor="#F4F4F4" >
  ...
  <td colspan="3" > <br />
   <input type="text" name="date_bio_report" id="date_bio_report"  value="<?php echo $dbarr['date_bio_report']; ?>"  size="10"  onkeyup="onaction();" />  (dd-mm-พ.ศ.(2500))
   <button type="button" onclick="calyear()" style="background-color:#7a5037;color:#FFFFFF;cursor:pointer;width:80px;">cal</button>
   <br />
   	<table width="160px"  style="border-radius: 6px;"      height="25px"  bgcolor="#cccccc"><tr><td><b><span id="yearold"></span></b><input type="hidden" id='input_yearold' value=""></td></tr></table>
 ...
 <tr bgcolor="#F4F4F4" >
  ...
  <tr bgcolor="#F4F4F4" >
   ...
   <tr bgcolor="#F4F4F4" >
    ...
    <td colspan="3" > <br />
      <select name="biopsy_site" style="width:150px;" id="biopsy_site" onchange="fc_oth_biopsy($(this));" >
     ...
     </select> <input type="text" name="oth_biopsy"  id="oth_biopsy" value="<?php echo $dbarr['oth_biopsy']; ?>" size="70px;"/> <br /><br /></td>
...
?>  onclick="onaction();"   />   Non-Hodgkin lymphoma (NHL) <br /><br />
    <div id="detail_non_hodgkin">
      ...
      <select name="type_non" id="type_non1" style="width:150px;">
       <option value="B" <?php if (trim($dbarr['type_non']) == "B") { echo "selected";}?> >B</option>
       <option value="T/NK"  <?php if (trim($dbarr['type_non']) == "T/NK") { echo "selected";}?>>T/NK</option>
       <option value="Unclassify"  <?php if (trim($dbarr['type_non']) == "Unclassify") { echo "selected";}?>>Unclassify</option>
       <option value="Not done"  <?php if (trim($dbarr['type_non']) == "Not done") { echo "selected";}?>>Not done</option>
     </select>
     <br />
     <input type="radio"   name="type_sub_non" value="WHO classification"  id="type_sub_non1" <?php if (trim($dbarr['type_sub_non']) == "WHO classification") {
    echo "checked";
}
?>   />   WHO classification  <br />
    <select name="who_sub" id="who_sub" style="width:400px;">
     <option value="">Please select..</option>
     <option value="07 : Precursor B-lymphoblastic lymphoma" <?php if ($who_s == "07 : Precursor B-lymphoblastic lymphoma") {echo " selected";}?> >07 : Precursor B-lymphoblastic lymphoma</option>
     <option value="08 : Small lymphocytic lymphoma" <?php if ($who_s == "08 : Small lymphocytic lymphoma") {echo " selected";}?> >08 : Small lymphocytic lymphoma</option>
     <option value="09 : Lymphoplasmacytic lymphoma" <?php if ($who_s == "09 : Lymphoplasmacytic lymphoma") {echo " selected";}?> >09 : Lymphoplasmacytic lymphoma</option>
     <option value="10 : Splenic marginal zone lymphoma" <?php if ($who_s == "10 : Splenic marginal zone lymphoma") {echo " selected";}?> >10 : Splenic marginal zone lymphoma</option>
     <option value="11 : Extranodal marginal zone lymphoma of MALT type" <?php if ($who_s == "11 : Extranodal marginal zone lymphoma of MALT type") {echo " selected";}?> >11 : Extranodal marginal zone lymphoma of MALT type</option>
     <option value="12 : Nodal marginal zone lymphoma" <?php if ($who_s == "12 : Nodal marginal zone lymphoma") {echo " selected";}?> >12 : Nodal marginal zone lymphoma</option>
     <option value="13A : In situ follicular neoplasia" <?php if ($who_s == "13A : In situ follicular neoplasia") {echo " selected";}?> >13A : In situ follicular neoplasia</option>
     <option value="13B : Duodenal-type follicular lymphoma" <?php if ($who_s == "13B : Duodenal-type follicular lymphoma") {echo " selected";}?> >13B : Duodenal-type follicular lymphoma</option>
     <option value="13 : Follicular lymphoma, grade 1" <?php if ($who_s == "13 : Follicular lymphoma, grade 1") {echo " selected";}?> >13 : Follicular lymphoma, grade 1</option>
     <option value="14 : Follicular lymphoma, grade 2" <?php if ($who_s == "14 : Follicular lymphoma, grade 2") {echo " selected";}?> >14 : Follicular lymphoma, grade 2</option>
     <option value="15 : Follicular lymphoma, grade 3" <?php if ($who_s == "15 : Follicular lymphoma, grade 3") {echo " selected";}?> >15 : Follicular lymphoma, grade 3</option>
     <option value="16A : In situ mantle cell neoplasia" <?php if ($who_s == "16A : In situ mantle cell neoplasia") {echo " selected";}?> >16A : In situ mantle cell neoplasia</option>
     <option value="16 : Mantle cell lymphoma" <?php if ($who_s == "16 : Mantle cell lymphoma") {echo " selected";}?> >16 : Mantle cell lymphoma</option>
     <option value="17 : Diffuse large B-cell lymphoma (DLBCL), NOS" <?php if ($who_s == "17 : Diffuse large B-cell lymphoma (DLBCL), NOS") {echo " selected";}?> >17 : Diffuse large B-cell lymphoma (DLBCL), NOS</option>
     <option value="17A : Germinal center B-cell (GCB) DLBCL" <?php if ($who_s == "17A : Germinal center B-cell (GCB) DLBCL") {echo " selected";}?> >17A : Germinal center B-cell (GCB) DLBCL</option>
     <option value="17B : Activated B-cell (ABC) DLBCL" <?php if ($who_s == "17B : Activated B-cell (ABC) DLBCL") {echo " selected";}?> >17B : Activated B-cell (ABC) DLBCL</option>
     <option value="18 : Mediastinal (thymic) large B-cell lymphoma" <?php if ($who_s == "18 : Mediastinal (thymic) large B-cell lymphoma") {echo " selected";}?> >18 : Mediastinal (thymic) large B-cell lymphoma</option>
     <option value="19 : Intravascular large B-cell lymphoma" <?php if ($who_s == "19 : Intravascular large B-cell lymphoma") {echo " selected";}?> >19 : Intravascular large B-cell lymphoma</option>
     <option value="20 : Primary effusion lymphoma" <?php if ($who_s == "20 : Primary effusion lymphoma") {echo " selected";}?> >20 : Primary effusion lymphoma</option>
     <option value="21 : Burkitt lymphoma" <?php if ($who_s == "21 : Burkitt lymphoma") {echo " selected";}?> >21 : Burkitt lymphoma</option>
     <option value="22 : Lymphomatoid granulomatosis" <?php if ($who_s == "22 : Lymphomatoid granulomatosis") {echo " selected";}?> >22 : Lymphomatoid granulomatosis</option>
     <option value="23 : Post-transplant lymphoproliferative disorders(PTLD)" <?php if ($who_s == "23 : Post-transplant lymphoproliferative disorders(PTLD)") {echo " selected";}?> >23 : Post-transplant lymphoproliferative disorders(PTLD)</option>
     <option value="24 : Precursor T-lymphoblastic lymphoma" <?php if ($who_s == "24 : Precursor T-lymphoblastic lymphoma") {echo " selected";}?> >24 : Precursor T-lymphoblastic lymphoma</option>
     <option value="25 : Extranodal NK/T-cell lymphoma, nasal type" <?php if ($who_s == "25 : Extranodal NK/T-cell lymphoma, nasal type") {echo " selected";}?> >25 : Extranodal NK/T-cell lymphoma, nasal type</option>
     <option value="26 : Enteropathy-type T-cell lymphoma" <?php if ($who_s == "26 : Enteropathy-type T-cell lymphoma") {echo " selected";}?> >26 : Enteropathy-type T-cell lymphoma</option>
     <option value="26A : Enteropathy-associated T-cell lymphoma(TypeI EALT)" <?php if ($who_s == "26A : Enteropathy-associated T-cell lymphoma(TypeI EALT)") {echo " selected";}?> >26A : Enteropathy-associated T-cell lymphoma(TypeI EALT)</option>
     <option value="26B : Monomorphic epitheliotroptic intestinal T-cell lymphoma(TypeII EATL)" <?php if ($who_s == "26B : Monomorphic epitheliotroptic intestinal T-cell lymphoma(TypeII EATL)") {echo " selected";}?> >26B : Monomorphic epitheliotroptic intestinal T-cell lymphoma(TypeII EATL)</option>
     <option value="27 : Hepatosplenic T-cell lymphoma" <?php if ($who_s == "27 : Hepatosplenic T-cell lymphoma") {echo " selected";}?> >27 : Hepatosplenic T-cell lymphoma</option>
     <option value="28 : Subcutaneous panniculitis-like T-cell lymphoma" <?php if ($who_s == "28 : Subcutaneous panniculitis-like T-cell lymphoma") {echo " selected";}?> >28 : Subcutaneous panniculitis-like T-cell lymphoma</option>
     <option value="29 : Aggressive NK-cell leukemia/lymphoma" <?php if ($who_s == "29 : Aggressive NK-cell leukemia/lymphoma") {echo " selected";}?> >29 : Aggressive NK-cell leukemia/lymphoma</option>
     <option value="30 : Mycosis fungoides/Sezary syndrome" <?php if ($who_s == "30 : Mycosis fungoides/Sezary syndrome") {echo " selected";}?> >30 : Mycosis fungoides/Sezary syndrome</option>
     <option value="31 : Angioimmunblastic T-cell lymphoma" <?php if ($who_s == "31 : Angioimmunblastic T-cell lymphoma") {echo " selected";}?> >31 : Angioimmunblastic T-cell lymphoma</option>
     <option value="32 : Primary cutaneous anaplastic large cell lymphoma" <?php if ($who_s == "32 : Primary cutaneous anaplastic large cell lymphoma") {echo " selected";}?> >32 : Primary cutaneous anaplastic large cell lymphoma</option>
     <option value="33 : Anaplastic large cell lymphoma, ALK positive" <?php if ($who_s == "33 : Anaplastic large cell lymphoma, ALK positive") {echo " selected";}?> >33 : Anaplastic large cell lymphoma, ALK positive</option>
     <option value="34 : Peripheal T-cell lymphoma, unspecified, NOS" <?php if ($who_s == "34 : Peripheal T-cell lymphoma, unspecified, NOS") {echo " selected";}?> >34 : Peripheal T-cell lymphoma, unspecified, NOS</option>
     <option value="--**New entity**--" <?php if ($who_s == "--**New entity**--") {echo " selected";}?> >--**New entity**--</option>
     <option value="35 : T-cell/histiocyte-rich large B-cell lymphoma" <?php if ($who_s == "35 : T-cell/histiocyte-rich large B-cell lymphoma") {echo " selected";}?> >35 : T-cell/histiocyte-rich large B-cell lymphoma</option>
     <option value="36 : Primary cutaneous follicle enter lymphoma" <?php if ($who_s == "36 : Primary cutaneous follicle enter lymphoma") {echo " selected";}?> >36 : Primary cutaneous follicle enter lymphoma</option>
     <option value="37 : Primary DLBCL of the CNS" <?php if ($who_s == "37 : Primary DLBCL of the CNS") {echo " selected";}?> >37 : Primary DLBCL of the CNS</option>
     <option value="38 : Primry cutaneous DLBCL, leg type " <?php if ($who_s == "38 : Primry cutaneous DLBCL, leg type ") {echo " selected";}?> >38 : Primry cutaneous DLBCL, leg type </option>
     <option value="39 : EBV+DLBCL NOS " <?php if ($who_s == "39 : EBV+DLBCL NOS ") {echo " selected";}?> >39 : EBV+DLBCL NOS </option>
     <option value="40 : ALK positive large B-cell lymphoma" <?php if ($who_s == "40 : ALK positive large B-cell lymphoma") {echo " selected";}?> >40 : ALK positive large B-cell lymphoma</option>
     <option value="41 : Plasmablastic lymphoma" <?php if ($who_s == "41 : Plasmablastic lymphoma") {echo " selected";}?> >41 : Plasmablastic lymphoma</option>
     <option value="42 : Large B-cell lymphoma arising in HHV8-associated multicentric Castleman disease(HHV8+ DLBCL, NOS)" <?php if ($who_s == "42 : Large B-cell lymphoma arising in HHV8-associated multicentric Castleman disease(HHV8+ DLBCL, NOS)") {echo " selected";}?> >42 : Large B-cell lymphoma arising in HHV8-associated multicentric Castleman disease(HHV8+ DLBCL, NOS)</option>
     <option value="43 : With features intermediate between DLBCL and Burkitt lymphoma" <?php if ($who_s == "43 : With features intermediate between DLBCL and Burkitt lymphoma") {echo " selected";}?> >43 : With features intermediate between DLBCL and Burkitt lymphoma</option>
     <option value="43A : High-grade B-call lymphoma, with feature intermediate between DLBCL and classical Hodgkin lymphoma" <?php if ($who_s == "43A : High-grade B-call lymphoma, with feature intermediate between DLBCL and classical Hodgkin lymphoma") {echo " selected";}?> >43A : High-grade B-call lymphoma, with feature intermediate between DLBCL and classical Hodgkin lymphoma</option>
     <option value="44 : B-cell lymphoma, unclassifiable, with features intermediate between DLBCL and classical Hodgkin lymphoma" <?php if ($who_s == "44 : B-cell lymphoma, unclassifiable, with features intermediate between DLBCL and classical Hodgkin lymphoma") {echo " selected";}?> >44 : B-cell lymphoma, unclassifiable, with features intermediate between DLBCL and classical Hodgkin lymphoma</option>
     <option value="45 : Chronic lymphoproliferative disorder of NK-cells" <?php if ($who_s == "45 : Chronic lymphoproliferative disorder of NK-cells") {echo " selected";}?> >45 : Chronic lymphoproliferative disorder of NK-cells</option>
     <option value="46 : Lymphomatoid papulosis" <?php if ($who_s == "46 : Lymphomatoid papulosis") {echo " selected";}?> >46 : Lymphomatoid papulosis</option>
     <option value="47 : Primary cutaneous gamma-delta T-cell lymphoma" <?php if ($who_s == "47 : Primary cutaneous gamma-delta T-cell lymphoma") {echo " selected";}?> >47 : Primary cutaneous gamma-delta T-cell lymphoma</option>
     <option value="48 : Primary cutaneous CD8 positive aggressive epidermotropic cytotoxic T-cell lymphoma" <?php if ($who_s == "48 : Primary cutaneous CD8 positive aggressive epidermotropic cytotoxic T-cell lymphoma") {echo " selected";}?> >48 : Primary cutaneous CD8 positive aggressive epidermotropic cytotoxic T-cell lymphoma</option>
     <option value="49 : Primary cutaneous CD4 positive small/medium T-cell lymphoma" <?php if ($who_s == "49 : Primary cutaneous CD4 positive small/medium T-cell lymphoma") {echo " selected";}?> >49 : Primary cutaneous CD4 positive small/medium T-cell lymphoma</option>
     <option value="50 : Anaplastic large cell lymphoma, ALK negative" <?php if ($who_s == "50 : Anaplastic large cell lymphoma, ALK negative") {echo " selected";}?> >50 : Anaplastic large cell lymphoma, ALK negative</option>
     <option value="51 : Breast implant-associated anaplastic large-cell lymphoma" <?php if ($who_s == "51 : Breast implant-associated anaplastic large-cell lymphoma") {echo " selected";}?> >51 : Breast implant-associated anaplastic large-cell lymphoma</option>
     <option value="52 : DLBCL associated with chronic inflammation" <?php if ($who_s == "52 : DLBCL associated with chronic inflammation") {echo " selected";}?> >52 : DLBCL associated with chronic inflammation</option>
   </select>
   <br />
   <input type="radio"  name="type_sub_non"  id="type_sub_non2" value="Working formulation"  <?php if (trim($dbarr['type_sub_non']) == "Working formulation") {
    echo "checked";
}
?> />  Working formulation  <br />
  <select name="work_sub" id="work_sub" style="width:400px;" >

    <option value="07 : NHL, small lymphocytic without plasmacytoid differentiation"  <?php if ($work_s == "07 : NHL, small lymphocytic without plasmacytoid differentiation") {echo " selected";}?>>07 : NHL, small lymphocytic without plasmacytoid differentiation</option>
    <option value="08 : NHL, small lymphocytic with plasmacytoid differentiation"  <?php if ($work_s == "08 : NHL, small lymphocytic with plasmacytoid differentiation") {echo " selected";}?>>08 : NHL, small lymphocytic with plasmacytoid differentiation</option>
    <option value="09 : NHL, follicular, small cleaved"  <?php if ($work_s == "09 : NHL, follicular, small cleaved") {echo " selected";}?>>09 : NHL, follicular, small cleaved</option>
    <option value="10 : NHL, follicular, mixed small cleaved and large cell"  <?php if ($work_s == "10 : NHL, follicular, mixed small cleaved and large cell") {echo " selected";}?>>10 : NHL, follicular, mixed small cleaved and large cell</option>
    <option value="11 : NHL, follicular, large cell"  <?php if ($work_s == "11 : NHL, follicular, large cell") {echo " selected";}?>>11 : NHL, follicular, large cell</option>
    <option value="12 : NHL, diffuse, small cleaved"  <?php if ($work_s == "12 : NHL, diffuse, small cleaved") {echo " selected";}?>>12 : NHL, diffuse, small cleaved</option>
    <option value="13 : NHL, diffuse, mixed small and large cell"  <?php if ($work_s == "13 : NHL, diffuse, mixed small and large cell") {echo " selected";}?>>13 : NHL, diffuse, mixed small and large cell</option>
    <option value="14 : NHL, diffuse, large cell"  <?php if ($work_s == "14 : NHL, diffuse, large cell") {echo " selected";}?>>14 : NHL, diffuse, large cell</option>
    <option value="15 : NHL, large cell immunoblastic"  <?php if ($work_s == "15 : NHL, large cell immunoblastic") {echo " selected";}?>>15 : NHL, large cell immunoblastic</option>
    <option value="16 : NHL, lymphoblastic type"  <?php if ($work_s == "16 : NHL, lymphoblastic type") {echo " selected";}?>>16 : NHL, lymphoblastic type</option>
    <option value="17 : NHL, small non-cleaved Burkitt type"  <?php if ($work_s == "17 : NHL, small non-cleaved Burkitt type") {echo " selected";}?>>17 : NHL, small non-cleaved Burkitt type</option>
    <option value="18 : NHL, small non-cleaved non-Burkitt type"  <?php if ($work_s == "18 : NHL, small non-cleaved non-Burkitt type") {echo " selected";}?>>18 : NHL, small non-cleaved non-Burkitt type</option>
    <option value="19 : Composite lymphoma"  <?php if ($work_s == "19 : Composite lymphoma") {echo " selected";}?>>19 : Composite lymphoma</option>
    <option value="20 : Histiocytic lymphoma"  <?php if ($work_s == "20 : Histiocytic lymphoma") {echo " selected";}?>>20 : Histiocytic lymphoma</option>
    <option value="21 : Mycosis fungoides/Sezary syndrome"  <?php if ($work_s == "21 : Mycosis fungoides/Sezary syndrome") {echo " selected";}?>>21 : Mycosis fungoides/Sezary syndrome</option>
    <option value="22 : NHL, unclassifiable"  <?php if ($work_s == "22 : NHL, unclassifiable") {echo " selected";}?>>22 : NHL, unclassifiable</option>
  </select>
  <br />
  <input type="radio" name="type_sub_non"  id="type_sub_non3"  value="99 Other type" <?php if (trim($dbarr['type_sub_non'])== "99 Other type") {
    echo "checked";
}
?> />  99 Other type  <br />
...
?>  />  none
    ...
    <div id="extra_site">
      <br />
      <input type="checkbox" name="ext_wal"   value="Waldeyer's ring" id="ext_wal" <?php if ($dbarr['ext_wal'] == 'Waldeyer\'s ring') {
    echo "checked";
}
...
<tr bgcolor="#F4F4F4" >
  ...
  <td><br />
    ...
    <input type="radio"   name="status_bulky"   value="yes" <?php if ($dbarr['status_bulky'] == "yes") {
    echo "checked";
}
?>  >  YES  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio"   name="status_bulky"   value="no"   <?php if ($dbarr['status_bulky'] == "no") {
    echo "checked";
}
?>> NO
    <br /><br />
    <strong>Maximum diameter : </strong><input type="text"   name="bulky"   value="<?php echo $dbarr['bulky']; ?>"   >    (cm) 
    <br /><br />
  </td>
</tr>
...
<tr bgcolor="#F4F4F4" >
 <td colspan="4" align="center">
   ...
   $field_search = $_GET["field_search"];
    if($_SESSION['ty_user']==2){$txtul  = "http://thailymphomaregistry.org/admin.php?name=admin&file=data_all&finddata=$finddata&field_search=$field_search";}
    if($_SESSION['ty_user']==1){$txtul = "http://thailymphomaregistry.org/index.php";}
	
	//echo $txtul;   
   ?>
   <button  type="submit" id="save"  value="save" disabled style="background-color:#7a5037;color:#FFFFFF;cursor:pointer;width:120px;">Save</button>   &nbsp;&nbsp;&nbsp;&nbsp;
   <button  type="submit" id="drafts" name="drafts" value="Save drafts"  style="background-color:#7a5037;color:#FFFFFF;cursor:pointer;width:120px;" />Save drafts</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <input name="Submit2" type="button" class="button" value="Cancel" onClick="window.location='<?=$txtul?>'" style="background-color:#7a5037;color:#FFFFFF;cursor:pointer;width:120px;">&nbsp;&nbsp;&nbsp;&nbsp;
   <br /><br />
   <script type="text/javascript">


var oth_biopsy =  document.getElementById("oth_biopsy");
<?php
  if ($dbarr['biopsy_site'] == "Others") {
?>
   oth_biopsy.style.visibility = "visible";

<?php
  }else{
?>
   oth_biopsy.style.visibility = "hidden";
<?php
  }
?>
 function fc_oth_biopsy(x){
  if(x.val()=="Others"){
    oth_biopsy.style.visibility = "visible";
  }else{
   oth_biopsy.style.visibility = "hidden";
