...
$codehos= $dbarr["codehos"];
	    ...
	    $hb_6m = $_POST["hb_6m"];
		$wbc_6m = $_POST["wbc_6m"];		
		$platelet_count_6m = $_POST["platelet_count_6m"];		
		$basophil_6m = $_POST["basophil_6m"];		
		$eosinophil_6m = $_POST["eosinophil_6m"];		
		$blast_cell_6m = $_POST["blast_cell_6m"];		
...
$platelet_count_6m = htmlspecialchars($platelet_count_6m) ;
$basophil_6m = htmlspecialchars($basophil_6m) ;
$eosinophil_6m = htmlspecialchars($eosinophil_6m) ;
$blast_cell_6m = htmlspecialchars($blast_cell_6m) ;
