...
<TABLE width="90%" align=center cellSpacing=0 cellPadding=0 border=0>
    <TR>
        <TD>
&nbsp;&nbsp;&nbsp;<h1>&nbsp;&nbsp;&nbsp;&nbsp;เพิ่มหัวข้อการแลกเปลี่ยนเวร</h1>
<?
//Post Action
if($_GET[action] == "post"){
	//Check data
...
<TR>
	<TD><CENTER><B>ข้อมูลหัวข้อได้ทำการเพิ่มเรียบร้อยแล้ว</B><BR><BR>
	<A HREF="admin.php?name=admin&amp;file=change">คลิกที่นี่เพื่อดูรายการทั้งหมด</A>
	</CENTER></TD>
</TR>
</TABLE><BR><BR>
<?
...
<TR>
	<TD width=150 align=right> <B>วันที่ต้องการแลกหรือจ้าง : </B></TD>
	<TD>
...
&nbsp;ปี&nbsp;<input type="text" name="change_year" id="" maxlength="4"  />
	</TD>
</TR>
<TR>
...
<TR>
	...
	<TD><INPUT TYPE="submit" value=" ตั้งหัวข้อ " > </TD>
</TR>
</TABLE>
</FORM>
<?
