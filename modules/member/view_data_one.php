...
<div id="center">
		 ...
		 <tr bgcolor="#F4F4F4"  bgcolor="#F4F4F4" ><td style="padding-left:35px;padding-top:15px">
  ...
  color:#18222e;
    ...
    <table width="100%" border="0" align="center">
      <tr bgcolor="#F4F4F4" >
        ...
        <td colspan="3"> <br />
          วันที่ <b><?php echo $dro_date; ?>(พ.ศ.)</b>
          <br /><br />    </td>
        </tr>
        <tr bgcolor="#F4F4F4" >
...
<tr bgcolor="#F4F4F4" >
  ...
  <td colspan="3" > <br />
   <?php
       ...
       $date_bio =  $dbarr['date_bio_report']; 
	 
	   $pos = strpos($date_bio, "-");
   if ($pos === false) {
        
		 $n1 = substr($date_bio,0,2);
		 $n2 = substr($date_bio,2,2);
		 $n3 = substr($date_bio,4,4);
		 echo $n1."-".$n2."-".$n3;
...
<tr bgcolor="#F4F4F4" >
 ...
 <td><br />
  <?php echo $dbarr['hemoglobin']; ?> Hemoglobin(g/dl) <br /><br />
  <?php echo $dbarr['mcv']; ?>   MCV(fL)  <br /><br />
  <?php echo $dbarr['wbc']; ?>   WBC(10<sup>3</sup>/&#956;L)  <br /><br />
  <?php echo $dbarr['platelet']; ?> Platelet(10<sup>3</sup>/&#956;L)  <br /><br />
  <?php echo $dbarr['neutrophil']; ?> Neutrophil(%)  <br /><br />
  <?php echo $dbarr['lymphocyte']; ?>  Lymphocyte(%)  <br /><br />
  <?php echo $dbarr['monocyte']; ?>  Monocyte(%)  <br /><br />
  <?php echo $dbarr['eosinophil']; ?>  Eosinophil(%)  <br /><br />
  <?php echo $dbarr['basophil']; ?>  Basophil(%)  <br /><br />
  <?php echo $dbarr['luc']; ?>  LUC  <br /><br />
  Blast/Lymphoma cell(yes/no) : <?php if ($dbarr['blast_lymphoma'] == "Yes") {
    echo "Yes";
} else {
   echo "No";
}
...
<tr bgcolor="#F4F4F4" >
  ...
  <td><br /><b>HBsAg :</b>  <?php if ($dbarr['hep_b_hbsag'] == "posiive") {
    echo "posiive";
} else if ($dbarr['hep_b_hbsag'] == "negative") {
    echo "negative";
} else if ($dbarr['hep_b_hbsag'] == "not done") {
    echo "not done";
}
?> <br /><br />
    <b>Anti-HBcAb : </b>  <?php if ($dbarr['hep_b_anti_hbcab'] == "posiive") {
    echo "posiive";
} else if ($dbarr['hep_b_anti_hbcab'] == "negative") {
    echo "negative";
} else if ($dbarr['hep_b_anti_hbcab'] == "not done") {
    echo "not done";
}
?> <br /><br />
    <b>Anti-HBsAb :</b>
    <?php if ($dbarr['hep_b_anti_hbsab'] == "posiive") {
    echo "posiive";
} else if ($dbarr['hep_b_anti_hbsab'] == "negative") {
    echo "negative";
} else if ($dbarr['hep_b_anti_hbsab'] == "not done") {
    echo "not done";
}
?> <br /><br />
...
<tr bgcolor="#F4F4F4" >
  ...
  <td><br /><b> Anti-HCV : </b>    <?php if ($dbarr['hep_c_anti_hcv'] == "posiive") {
    echo "posiive";
} else if ($dbarr['hep_c_anti_hcv'] == "negative") {
    echo "negative";
} else if ($dbarr['hep_c_anti_hcv'] == "not done") {
    echo "not done";
}
?> <br /><br />
  </td>
...
<tr bgcolor="#F4F4F4" >
  ...
  <td><br />
    <strong>Status :</strong>
      <?php if ($dbarr['status_bulky'] == "yes") {
          echo "Yes";
      } else if ($dbarr['status_bulky'] == "no") {
          echo "No";
      }
      ?><br /><br />
      <strong>Maximun diameter :</strong>
      <?php 
        if ($dbarr['bulky'] == ""){
          echo ' - ';
        } else {
...
<tr bgcolor="#F4F4F4" >
 <td colspan="4" align="center">
   <br /><Br />
   <button  type="button" id="ELR" onclick="gotoELR('<?php echo $_GET['id'] ?>')" style="background-color:#7a5037;color:#FFFFFF;cursor:pointer;width:180px;">Edit Lymphoma Registry</button>   &nbsp;&nbsp;&nbsp;&nbsp;
   <button  type="button" id="EFR" onclick="gotoEFR('<?php echo $_GET['id'] ?>')" style="background-color:#7a5037;color:#FFFFFF;cursor:pointer;width:180px;">Edit Follow Up Registry</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <button type="button" class="button"  onClick="window.history.back(); " style="background-color:#7a5037;color:#FFFFFF;cursor:pointer;width:120px;">Back</button>&nbsp;&nbsp;&nbsp;&nbsp;
   <br /><br />
   <script type="text/javascript">
	   calyear();
