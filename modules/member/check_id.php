...
// $password = "VB-D#ThaAi#LogCe&";
    ...
    { ?>
        ...
        <?
        echo "<span style='margin-top:10px; color:red;' id='show_data1'class='alert-danger form-control'>มีผู้ใช้งาน ID นี้แล้ว กรุณาเปลี่ยน ID</span>";  
        echo "<span style='margin-top:10px; color:green;' id='show_data2' class='alert-success form-control'>สามารถใช้งาน ID นี้ได้</span>";  
    } 
