...
<tr bgcolor="#F4F4F4" >
 <td colspan="4" align="center">
   ...
   $field_search = $_GET["field_search"];
    if($_SESSION['ty_user']==2){$txtul  = "http://localhost:8888/admin.php?name=admin&file=data_all&finddata=$finddata&field_search=$field_search";}
    if($_SESSION['ty_user']==1){$txtul = "http://localhost:8888/index.php";}
