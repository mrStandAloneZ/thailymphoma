...
textarea{
 ...
 font-size: 15px;
  color:#18222e;
       ...
       <form id="checkForm" name="checkForm" method="post" action="?name=member&file=member_add_pageone_newtest"  onSubmit="return check()" enctype="multipart/form-data" >
...
<tr bgcolor="#F4F4F4" >
  ...
  <td colspan="3" > <br />
   <input type="text" name="date_bio_report" id="date_bio_report"  size="10" onkeyup="onaction();"/> (dd-mm-พ.ศ.(2500))
   
    <button type="button" onclick="calyear()"  style="background-color:#7a5037;color:#FFFFFF;cursor:pointer;width:80px;">cal</button><br />
	
	<table width="160px"  style="border-radius: 6px;margin-left:2px;"      height="25px"  bgcolor="#cccccc"><tr><td><b><span id="yearold"></span></b></td></tr></table>
...
<table><tr><td>
   <select name="biopsy_site" id="biopsy_site" style="width:150px;" onchange="fc_oth_biopsy($(this));">
...
<tr bgcolor="#F4F4F4" >
  ...
  <td colspan="3" > <br />
    ...
    <div id="extra_site">
      ...
      <br />
      <input type="checkbox" name="ext_lung"   value="Lung/Pleura"   id="ext_lung"onclick="checkage();" >  Lung/Pleura &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php //******   ยฟร”ร…ยดรฌยทร•รจร ยพร”รจรÿยขร–รฉยนรÿร’รฃรÿรÿรจ  ?>
...
<tr bgcolor="#F4F4F4" >
 ...
 <td colspan="4" align="center">
   ...
   <br /><br />
   <font color="#CC3300">* กรณีทำการ Save ข้อมูลปกติจำเป็นจะต้องกรอกข้อมูลให้ครบทุกช่องค่ะ !</font>
   <br />
