...
While  ($Recs<=$Pagesize)	// แสดงเรกคอร์ดจำนวนไม่เกินจำนวนเรกคอร์ดต่อหน้า
	{		
			if($count<$numrows)
		   {
			...
			if($patient_initials != "" && $diagnosis_cml != "" && $date_diagnosis != "" && $date_birth !="" && $genden !="" && $current_address !="" && $zip_code !="" && $payment !="" && $date_assessment !="" && $ecog_score !="" &&  $hematology_lab1 !="" && $hematology_lab2 !=""  && $platelet_count != ""  && $basophil != "" && $eosinophil != "" && $blast_cell && $euro_hasford !="" && $eutos !=""  &&  $cytogenetic_study !="" && $ph_chromosome !="" && $number_metaphase != "" && $add_chrom != "" && $bcr_abl != "" && $definitive != "" && $daily_dose != "" && $date_start != "" && $allogeneic_sct != "" && $date_transplantation != "" ){
						$registry_show ="1";
				} else if($status == "2"){ 
						$registry_show ="2";
				} else {
	...
	<?			if ($registry_show == 2){		//  ส่วนของการเปรียบเทียบข้อมูล ว่าตอนนี้อยู่ในสถานะไหน ถ้าส่งข้อมูลให้ส่วนกลางแล้วไม่สามารถ ให้แก้ไขข้อมูลได้ครับ			
			 echo" <td><center>
					...
					echo "  <td>
							<A Href='index.php?name=member&file=edit_data_one&id=$id'>$registry_show</A>
						</td> ";
				}  ?>   
			<? 
			if ($registry_show == 2){	
	...
	echo		  " <Td><center><a href='index.php?name=member&file=edit_data_6m&id=$id'>$month_6m_show</a></center></Td>    
			   <td><center><a href='index.php?name=member&file=edit_data_9m&id=$id'>$month_9m_show</a></center></td>
			   <Td><center><a href='index.php?name=member&file=edit_data_12m&id=$id'>$month_12m_show</a></center></Td>
			   <Td><center><a href='index.php?name=member&file=edit_data_18m&id=$id'>$month_18m_show</a></center></Td>       
			   <Td><center><a href='index.php?name=member&file=edit_data_24m&id=$id'>$month_24m_show</a></center></Td>      
   			   <Td><center><a href='index.php?name=member&file=edit_data_36m&id=$id'>$month_36m_show</a></center></Td>
      		   <Td><center><a href='index.php?name=member&file=edit_data_48m&id=$id'>$month_48m_show</a></center></Td>
			   <Td><center><A Href='index.php?name=member&file=edit_data_60m&id=$id'>$month_60m_show</center></A></Td>       
			  <td><center>
			<A href='index.php?name=member&file=edit_data_pthree&id=$id'>$second_lind</center></a>
			</td> 
			<td><center><A Href='index.php?name=member&file=edit_data_pfour&id=$id'>$third_lind</center></A></td>
     		<td><center><A Href='index.php?name=member&file=edit_data_pfive&id=$id'>$last</center></A></td>
