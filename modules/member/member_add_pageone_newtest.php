...
echo "<pre>"; 	
	print_r($_SESSION['login_true'] . "</br>");
	print_r($dbarr);
echo "</pre>"; 	
...
?>
  ...
  <?  	
  require_once("includes/add_data_newtest.php");
...
$txt_st = $txt_st."1,";
    $number_ext++;
												...
												// คำสั่ง SQL และสั่งให้ทำงาน
													$sql = "insert into  web_add_data_newtest (centre,
													codehos,
													subject,
													patient_initials,
													dateofrecord,
									 ...
									 values ('$idcen',
										...
										// $dbquery = mysql_db_query($dbname, $sql) or die('error test');
										// 	mysql_close();			
							?>				
         <?
